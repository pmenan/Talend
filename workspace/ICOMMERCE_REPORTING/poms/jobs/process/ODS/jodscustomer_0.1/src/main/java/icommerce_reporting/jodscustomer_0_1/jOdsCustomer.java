...
package icommerce_reporting.jodscustomer_0_1;
...
/**
 * Job: jOdsCustomer Purpose: alimentation de la table Client dans l'ODS<br>
 * Description: alimentation de la table Client dans l'ODS <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class jOdsCustomer implements TalendJob {
	...
	private final String jobName = "jOdsCustomer";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jOdsCustomer.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer.length) {
					if (length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer.length == 0) {
						commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[1024];
					} else {
						commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer, 0, length);
				strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer) {
	...
	public static class ligneRejectStruct implements routines.system.IPersistableRow<ligneRejectStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final ligneRejectStruct other = (ligneRejectStruct) obj;
		...
		public void copyDataTo(ligneRejectStruct other) {
		...
		public void copyKeysDataTo(ligneRejectStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(ligneRejectStruct other) {
	...
	public static class duplicateLignesStruct implements routines.system.IPersistableRow<duplicateLignesStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final duplicateLignesStruct other = (duplicateLignesStruct) obj;
		...
		public void copyDataTo(duplicateLignesStruct other) {
		...
		public void copyKeysDataTo(duplicateLignesStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(duplicateLignesStruct other) {
	...
	public static class insertNewCustomerStruct implements routines.system.IPersistableRow<insertNewCustomerStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final insertNewCustomerStruct other = (insertNewCustomerStruct) obj;
		...
		public void copyDataTo(insertNewCustomerStruct other) {
		...
		public void copyKeysDataTo(insertNewCustomerStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(insertNewCustomerStruct other) {
	...
	public static class insertUpdateClientStruct implements routines.system.IPersistableRow<insertUpdateClientStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final insertUpdateClientStruct other = (insertUpdateClientStruct) obj;
		...
		public void copyDataTo(insertUpdateClientStruct other) {
		...
		public void copyKeysDataTo(insertUpdateClientStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(insertUpdateClientStruct other) {
	...
	public static class AjoutNumSequenceStruct implements routines.system.IPersistableRow<AjoutNumSequenceStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCustomer = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(AjoutNumSequenceStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				AjoutNumSequenceStruct AjoutNumSequence = new AjoutNumSequenceStruct();
				row2Struct row2 = new row2Struct();
				row3Struct row3 = new row3Struct();
				insertNewCustomerStruct insertNewCustomer = new insertNewCustomerStruct();
				BlCurrentStruct BlCurrent = new BlCurrentStruct();
				insertUpdateClientStruct insertUpdateClient = new insertUpdateClientStruct();
				row6Struct row6 = new row6Struct();
				duplicateLignesStruct duplicateLignes = new duplicateLignesStruct();
				row5Struct row5 = new row5Struct();
				ligneRejectStruct ligneReject = new ligneRejectStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "insertNewCustomer");
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"NOM_CLIENT\" = ?,\"PREN_CLIENT\" = ?,\"CD_POSTAL_CLIENT\" = ?,\"VILLE_CLIENT\" = ?,\"PAYS_CLIENT\" = ?,\"REGION_CLIENT\" = ?,\"CD_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"ID_CLIENT\" = ?";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "insertUpdateClient");
				}
...
// # Outputs initialization
				insertNewCustomerStruct insertNewCustomer_tmp = new insertNewCustomerStruct();
				BlCurrentStruct BlCurrent_tmp = new BlCurrentStruct();
				insertUpdateClientStruct insertUpdateClient_tmp = new insertUpdateClientStruct();
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "duplicateLignes");
				}
...
// ###############################
// # Outputs initialization
				duplicateLignesStruct duplicateLignes_tmp = new duplicateLignesStruct();
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "ligneReject");
				}
...
// ###############################
// # Outputs initialization
				ligneRejectStruct ligneReject_tmp = new ligneRejectStruct();
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "AjoutNumSequence");
				}
...
// ###############################
// # Outputs initialization
				AjoutNumSequenceStruct AjoutNumSequence_tmp = new AjoutNumSequenceStruct();
// ###############################
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								AjoutNumSequence = null;

// # Output table : 'AjoutNumSequence'
								AjoutNumSequence_tmp.ID_CLIENT = row1.ID_CLIENT;
								AjoutNumSequence_tmp.NOM_CLIENT = row1.NOM_CLIENT;
								AjoutNumSequence_tmp.PREN_CLIENT = row1.PREN_CLIENT;
								AjoutNumSequence_tmp.CD_POSTAL_CLIENT = row1.CD_POSTAL_CLIENT;
								AjoutNumSequence_tmp.VILLE_CLIENT = row1.VILLE_CLIENT;
								AjoutNumSequence_tmp.PAYS_CLIENT = row1.PAYS_CLIENT;
								AjoutNumSequence_tmp.REGION_CLIENT = row1.REGION_CLIENT;
								AjoutNumSequence_tmp.CD_TYPE_CLIENT = row1.CD_TYPE_CLIENT;
								AjoutNumSequence_tmp.NUM_LIGNE = Numeric.sequence("s1", 1, 1);
								AjoutNumSequence = AjoutNumSequence_tmp;
// ###############################
							 ...
							 */
// Start of branch "AjoutNumSequence"
							if (AjoutNumSequence != null) {
								row5 = null;
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "AjoutNumSequence");
								}

								row5 = null;
								row2 = null;
								Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
								ope_tFilterRow_1.matches((// code sample : use AjoutNumSequence to define the condition.
// AjoutNumSequence.columnName1.equals("foo") ||!(AjoutNumSequence.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
								!AjoutNumSequence.NOM_CLIENT.isEmpty() && !AjoutNumSequence.PREN_CLIENT.isEmpty()),
								...
								if (ope_tFilterRow_1.getMatchFlag()) {
									...
									row2.ID_CLIENT = AjoutNumSequence.ID_CLIENT;
									row2.NOM_CLIENT = AjoutNumSequence.NOM_CLIENT;
									row2.PREN_CLIENT = AjoutNumSequence.PREN_CLIENT;
									row2.CD_POSTAL_CLIENT = AjoutNumSequence.CD_POSTAL_CLIENT;
									row2.VILLE_CLIENT = AjoutNumSequence.VILLE_CLIENT;
									row2.PAYS_CLIENT = AjoutNumSequence.PAYS_CLIENT;
									row2.REGION_CLIENT = AjoutNumSequence.REGION_CLIENT;
									row2.CD_TYPE_CLIENT = AjoutNumSequence.CD_TYPE_CLIENT;
									row2.NUM_LIGNE = AjoutNumSequence.NUM_LIGNE;
									nb_line_ok_tFilterRow_1++;
								} else {
									if (row5 == null) {
										row5 = new row5Struct();
									}
									row5.ID_CLIENT = AjoutNumSequence.ID_CLIENT;
									row5.NOM_CLIENT = AjoutNumSequence.NOM_CLIENT;
									row5.PREN_CLIENT = AjoutNumSequence.PREN_CLIENT;
									row5.CD_POSTAL_CLIENT = AjoutNumSequence.CD_POSTAL_CLIENT;
									row5.VILLE_CLIENT = AjoutNumSequence.VILLE_CLIENT;
									row5.PAYS_CLIENT = AjoutNumSequence.PAYS_CLIENT;
									row5.REGION_CLIENT = AjoutNumSequence.REGION_CLIENT;
									row5.CD_TYPE_CLIENT = AjoutNumSequence.CD_TYPE_CLIENT;
									row5.NUM_LIGNE = AjoutNumSequence.NUM_LIGNE;
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row3.NOM_CLIENT = row2.NOM_CLIENT;
										row3.PREN_CLIENT = row2.PREN_CLIENT;
										row3.CD_POSTAL_CLIENT = row2.CD_POSTAL_CLIENT;
										row3.VILLE_CLIENT = row2.VILLE_CLIENT;
										row3.PAYS_CLIENT = row2.PAYS_CLIENT;
										row3.REGION_CLIENT = row2.REGION_CLIENT;
										row3.CD_TYPE_CLIENT = row2.CD_TYPE_CLIENT;
										row3.NUM_LIGNE = row2.NUM_LIGNE;
										...
										row6.ID_CLIENT = row2.ID_CLIENT;
										row6.NOM_CLIENT = row2.NOM_CLIENT;
										row6.PREN_CLIENT = row2.PREN_CLIENT;
										row6.CD_POSTAL_CLIENT = row2.CD_POSTAL_CLIENT;
										row6.VILLE_CLIENT = row2.VILLE_CLIENT;
										row6.PAYS_CLIENT = row2.PAYS_CLIENT;
										row6.REGION_CLIENT = row2.REGION_CLIENT;
										row6.CD_TYPE_CLIENT = row2.CD_TYPE_CLIENT;
										row6.NUM_LIGNE = row2.NUM_LIGNE;
...
// Start of branch "row3"
									if (row3 != null) {
										...
										if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
											...
											row4HashKey.ID_CLIENT = row3.ID_CLIENT;
										...
										if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G
											...
											// 'row4' and it contains more one result from keys : row4.ID_CLIENT = '" +
											// row4HashKey.ID_CLIENT + "'");
										} // G 071
...
// # Filter conditions 
												...
												!row4.CD_POSTAL_CLIENT.equals(row3.CD_POSTAL_CLIENT)
														|| !row4.VILLE_CLIENT.equals(row3.VILLE_CLIENT)
														|| !row4.PAYS_CLIENT.equals(row3.PAYS_CLIENT)

												) {
													BlCurrent_tmp.ID_CLIENT = row4.ID_CLIENT;
													BlCurrent_tmp.NOM_CLIENT = row4.NOM_CLIENT;
													BlCurrent_tmp.PREN_CLIENT = row4.PREN_CLIENT;
													BlCurrent_tmp.CD_POSTAL_CLIENT = row4.CD_POSTAL_CLIENT;
													BlCurrent_tmp.VILLE_CLIENT = row4.VILLE_CLIENT;
													BlCurrent_tmp.PAYS_CLIENT = row4.PAYS_CLIENT;
													BlCurrent_tmp.REGION_CLIENT = row4.REGION_CLIENT;
													BlCurrent_tmp.CD_TYPE_CLIENT = row4.CD_TYPE_CLIENT;
													BlCurrent_tmp.LB_NOM_FICHIER = row4.LB_NOM_FICHIER;
													BlCurrent_tmp.DT_INSERTION = row4.DT_INSERTION;
													BlCurrent_tmp.BL_LIGNE_ACTIVE = 0;
													BlCurrent_tmp.LB_JOB_NAME = row4.LB_JOB_NAME;
													BlCurrent = BlCurrent_tmp;
												} // closing filter/reject

// # Output table : 'insertUpdateClient'
// # Filter conditions 
												if (
												...
												!row4.CD_POSTAL_CLIENT.equals(row3.CD_POSTAL_CLIENT)
													...
													insertUpdateClient_tmp.ID_CLIENT = row3.ID_CLIENT;
													insertUpdateClient_tmp.NOM_CLIENT = row3.NOM_CLIENT;
													insertUpdateClient_tmp.PREN_CLIENT = row3.PREN_CLIENT;
													insertUpdateClient_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT;
													insertUpdateClient_tmp.VILLE_CLIENT = row3.VILLE_CLIENT;
													insertUpdateClient_tmp.PAYS_CLIENT = row3.PAYS_CLIENT;
													insertUpdateClient_tmp.REGION_CLIENT = row3.REGION_CLIENT;
													insertUpdateClient_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT;
													insertUpdateClient_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("nom_flux"));
													insertUpdateClient_tmp.DT_INSERTION = TalendDate.getCurrentDate();
													insertUpdateClient_tmp.BL_LIGNE_ACTIVE = 0;
													insertUpdateClient_tmp.LB_JOB_NAME = jobName;
													insertUpdateClient = insertUpdateClient_tmp;
												} // closing filter/reject
											} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insertNewCustomer'
// # Filter conditions 
											if (rejectedInnerJoin_tMap_1) {
												insertNewCustomer_tmp.ID_CLIENT = row3.ID_CLIENT;
												insertNewCustomer_tmp.NOM_CLIENT = row3.NOM_CLIENT;
												insertNewCustomer_tmp.PREN_CLIENT = row3.PREN_CLIENT;
												insertNewCustomer_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT;
												insertNewCustomer_tmp.VILLE_CLIENT = row3.VILLE_CLIENT;
												insertNewCustomer_tmp.PAYS_CLIENT = row3.PAYS_CLIENT;
												insertNewCustomer_tmp.REGION_CLIENT = row3.REGION_CLIENT;
												insertNewCustomer_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT;
												insertNewCustomer_tmp.LB_NOM_FICHIER = ((String) globalMap
														.get("nom_flux"));
												insertNewCustomer_tmp.DT_INSERTION = TalendDate.getCurrentDate();
												insertNewCustomer_tmp.BL_LIGNE_ACTIVE = 1;
												insertNewCustomer_tmp.LB_JOB_NAME = jobName;
												insertNewCustomer = insertNewCustomer_tmp;
											} // closing filter/reject
// ###############################
										 ...
										 */
// Start of branch "insertNewCustomer"
										if (insertNewCustomer != null) {
											...
											if (execStat) {
												runStat.updateStatOnConnection(iterateId, 1, 1, "insertNewCustomer");
											}

											whetherReject_tDBOutput_1 = false;
											if (insertNewCustomer.ID_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(1, insertNewCustomer.ID_CLIENT);
											}

											if (insertNewCustomer.NOM_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(2, insertNewCustomer.NOM_CLIENT);
											}

											if (insertNewCustomer.PREN_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(3, insertNewCustomer.PREN_CLIENT);
											}

											if (insertNewCustomer.CD_POSTAL_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(4, insertNewCustomer.CD_POSTAL_CLIENT);
											}

											if (insertNewCustomer.VILLE_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(5, insertNewCustomer.VILLE_CLIENT);
											}

											if (insertNewCustomer.PAYS_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(6, insertNewCustomer.PAYS_CLIENT);
											}

											if (insertNewCustomer.REGION_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(7, insertNewCustomer.REGION_CLIENT);
											}

											if (insertNewCustomer.CD_TYPE_CLIENT == null) {
												pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(8, insertNewCustomer.CD_TYPE_CLIENT);
											}

											if (insertNewCustomer.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(9, insertNewCustomer.LB_NOM_FICHIER);
											}

											if (insertNewCustomer.DT_INSERTION != null) {
												pstmt_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(
														insertNewCustomer.DT_INSERTION.getTime()));
											} else {
												pstmt_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
											}

											pstmt_tDBOutput_1.setInt(11, insertNewCustomer.BL_LIGNE_ACTIVE);

											if (insertNewCustomer.LB_JOB_NAME == null) {
												pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(12, insertNewCustomer.LB_JOB_NAME);
											}
										...
										} // End of branch "insertNewCustomer"
...
// Start of branch "BlCurrent"
										if (BlCurrent != null) {
											...
											if (BlCurrent.NOM_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(1, BlCurrent.NOM_CLIENT);
											}

											if (BlCurrent.PREN_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(2, BlCurrent.PREN_CLIENT);
											}

											if (BlCurrent.CD_POSTAL_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(3, BlCurrent.CD_POSTAL_CLIENT);
											}

											if (BlCurrent.VILLE_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(4, BlCurrent.VILLE_CLIENT);
											}

											if (BlCurrent.PAYS_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(5, BlCurrent.PAYS_CLIENT);
											}

											if (BlCurrent.REGION_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(6, BlCurrent.REGION_CLIENT);
											}

											if (BlCurrent.CD_TYPE_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(7, BlCurrent.CD_TYPE_CLIENT);
											}

											if (BlCurrent.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(8, BlCurrent.LB_NOM_FICHIER);
											}

											if (BlCurrent.DT_INSERTION != null) {
												pstmt_tDBOutput_2.setTimestamp(9,
														new java.sql.Timestamp(BlCurrent.DT_INSERTION.getTime()));
											} else {
												pstmt_tDBOutput_2.setNull(9, java.sql.Types.TIMESTAMP);
											}

											pstmt_tDBOutput_2.setInt(10, BlCurrent.BL_LIGNE_ACTIVE);

											if (BlCurrent.LB_JOB_NAME == null) {
												pstmt_tDBOutput_2.setNull(11, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(11, BlCurrent.LB_JOB_NAME);
											}

											if (BlCurrent.ID_CLIENT == null) {
												pstmt_tDBOutput_2.setNull(12 + count_tDBOutput_2,
														java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(12 + count_tDBOutput_2,
														BlCurrent.ID_CLIENT);
											}
...
// Start of branch "insertUpdateClient"
										if (insertUpdateClient != null) {
											...
											if (execStat) {
												runStat.updateStatOnConnection(iterateId, 1, 1, "insertUpdateClient");
											}

											whetherReject_tDBOutput_3 = false;
											if (insertUpdateClient.ID_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(1, insertUpdateClient.ID_CLIENT);
											}

											if (insertUpdateClient.NOM_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(2, insertUpdateClient.NOM_CLIENT);
											}

											if (insertUpdateClient.PREN_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(3, insertUpdateClient.PREN_CLIENT);
											}

											if (insertUpdateClient.CD_POSTAL_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(4, insertUpdateClient.CD_POSTAL_CLIENT);
											}

											if (insertUpdateClient.VILLE_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(5, insertUpdateClient.VILLE_CLIENT);
											}

											if (insertUpdateClient.PAYS_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(6, insertUpdateClient.PAYS_CLIENT);
											}

											if (insertUpdateClient.REGION_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(7, insertUpdateClient.REGION_CLIENT);
											}

											if (insertUpdateClient.CD_TYPE_CLIENT == null) {
												pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(8, insertUpdateClient.CD_TYPE_CLIENT);
											}

											if (insertUpdateClient.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(9, insertUpdateClient.LB_NOM_FICHIER);
											}

											if (insertUpdateClient.DT_INSERTION != null) {
												pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(
														insertUpdateClient.DT_INSERTION.getTime()));
											} else {
												pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
											}

											pstmt_tDBOutput_3.setInt(11, insertUpdateClient.BL_LIGNE_ACTIVE);

											if (insertUpdateClient.LB_JOB_NAME == null) {
												pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(12, insertUpdateClient.LB_JOB_NAME);
											}
										...
										} // End of branch "insertUpdateClient"
...
// Start of branch "row6"
									if (row6 != null) {
										...
										{ // start of Var scope
											...
											duplicateLignes = null;

// # Output table : 'duplicateLignes'
											duplicateLignes_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											duplicateLignes_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											duplicateLignes_tmp.NUM_LIGNE_REJET = row6.NUM_LIGNE;
											duplicateLignes_tmp.LB_LIGNE_REJET = row6.ID_CLIENT;
											duplicateLignes_tmp.LB_MESSAGE_REJET = "Valeur en double pour ID_CLIENT";
											duplicateLignes_tmp.LB_NOM_FLUX = ((String) globalMap.get("nom_flux"));
											duplicateLignes_tmp.DT_REJET = TalendDate.getCurrentDate();
											duplicateLignes_tmp.LB_JOB_NAME = jobName;
											duplicateLignes = duplicateLignes_tmp;
// ###############################
										 ...
										 */
// Start of branch "duplicateLignes"
										if (duplicateLignes != null) {
											...
											if (execStat) {
												runStat.updateStatOnConnection(iterateId, 1, 1, "duplicateLignes");
											}

											whetherReject_tDBOutput_5 = false;
											if (duplicateLignes.LB_CHEMIN_FICHIER == null) {
												pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(1, duplicateLignes.LB_CHEMIN_FICHIER);
											}

											if (duplicateLignes.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(2, duplicateLignes.LB_NOM_FICHIER);
											}

											pstmt_tDBOutput_5.setInt(3, duplicateLignes.NUM_LIGNE_REJET);

											if (duplicateLignes.LB_LIGNE_REJET == null) {
												pstmt_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(4, duplicateLignes.LB_LIGNE_REJET);
											}

											if (duplicateLignes.LB_MESSAGE_REJET == null) {
												pstmt_tDBOutput_5.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(5, duplicateLignes.LB_MESSAGE_REJET);
											}

											if (duplicateLignes.LB_NOM_FLUX == null) {
												pstmt_tDBOutput_5.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(6, duplicateLignes.LB_NOM_FLUX);
											}

											if (duplicateLignes.DT_REJET != null) {
												pstmt_tDBOutput_5.setTimestamp(7,
														new java.sql.Timestamp(duplicateLignes.DT_REJET.getTime()));
											} else {
												pstmt_tDBOutput_5.setNull(7, java.sql.Types.TIMESTAMP);
											}

											if (duplicateLignes.LB_JOB_NAME == null) {
												pstmt_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(8, duplicateLignes.LB_JOB_NAME);
											}
...
// # Output table : 'ligneReject'
										ligneReject_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILEPATH"));
										ligneReject_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILE"));
										ligneReject_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE;
										ligneReject_tmp.LB_LIGNE_REJET = row5.NOM_CLIENT + '|' + row5.PREN_CLIENT;
										ligneReject_tmp.LB_MESSAGE_REJET = "Valeur à null dans les données";
										ligneReject_tmp.LB_NOM_FLUX = ((String) globalMap.get("nom_flux"));
										ligneReject_tmp.DT_REJET = TalendDate.getCurrentDate();
										ligneReject_tmp.LB_JOB_NAME = jobName;
										ligneReject = ligneReject_tmp;
// ###############################
...
// Start of branch "ligneReject"
									if (ligneReject != null) {
										...
										if (execStat) {
											runStat.updateStatOnConnection(iterateId, 1, 1, "ligneReject");
										}

										whetherReject_tDBOutput_4 = false;
										if (ligneReject.LB_CHEMIN_FICHIER == null) {
											pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(1, ligneReject.LB_CHEMIN_FICHIER);
										}

										if (ligneReject.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(2, ligneReject.LB_NOM_FICHIER);
										}

										pstmt_tDBOutput_4.setInt(3, ligneReject.NUM_LIGNE_REJET);

										if (ligneReject.LB_LIGNE_REJET == null) {
											pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(4, ligneReject.LB_LIGNE_REJET);
										}

										if (ligneReject.LB_MESSAGE_REJET == null) {
											pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(5, ligneReject.LB_MESSAGE_REJET);
										}

										if (ligneReject.LB_NOM_FLUX == null) {
											pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(6, ligneReject.LB_NOM_FLUX);
										}

										if (ligneReject.DT_REJET != null) {
											pstmt_tDBOutput_4.setTimestamp(7,
													new java.sql.Timestamp(ligneReject.DT_REJET.getTime()));
										} else {
											pstmt_tDBOutput_4.setNull(7, java.sql.Types.TIMESTAMP);
										}

										if (ligneReject.LB_JOB_NAME == null) {
											pstmt_tDBOutput_4.setNull(8, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(8, ligneReject.LB_JOB_NAME);
										}
							...
							} // End of branch "AjoutNumSequence"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "AjoutNumSequence");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "insertNewCustomer");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "insertUpdateClient");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "duplicateLignes");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "ligneReject");
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					System.err.println("Aucun fichier dans le repertoire " + context.projectFolder
							+ TalendDate.getDate("YYYYMMDD"));

					globalMap.put("tDie_1_DIE_MESSAGE", "Aucun fichier dans le repertoire " + context.projectFolder
							+ TalendDate.getDate("YYYYMMDD"));
					globalMap.put("tDie_1_DIE_MESSAGES", "Aucun fichier dans le repertoire " + context.projectFolder
							+ TalendDate.getDate("YYYYMMDD"));
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(insertNewCustomer,BlCurrent,insertUpdateClient)
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row4.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row4.NOM_CLIENT = null;
						} else {

							row4.NOM_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row4.PREN_CLIENT = null;
						} else {

							row4.PREN_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row4.CD_POSTAL_CLIENT = null;
						} else {

							row4.CD_POSTAL_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row4.VILLE_CLIENT = null;
						} else {

							row4.VILLE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							row4.PAYS_CLIENT = null;
						} else {

							row4.PAYS_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row4.REGION_CLIENT = null;
						} else {

							row4.REGION_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							row4.CD_TYPE_CLIENT = null;
						} else {

							row4.CD_TYPE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row4.LB_NOM_FICHIER = null;
						} else {

							row4.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row4.DT_INSERTION = null;
						} else {

							row4.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 10);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row4.BL_LIGNE_ACTIVE = 0;
						} else {

							row4.BL_LIGNE_ACTIVE = rs_tDBInput_1.getInt(11);
						...
						if (colQtyInRs_tDBInput_1 < 12) {
							...
							row4.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
						}
	...
	public void tChronometerStop_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tChronometerStop_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println(
						"Nombre de lignes insérées : " + ((Integer) globalMap.get("tDBOutput_1_NB_LINE_INSERTED")));
				System.out.println("Nombre de lignes insérées mises à jour : "
	...
	public void tSetGlobalVar_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("nom_flux", "CUSTOMER");
	...
	public static void main(String[] args) {
		final jOdsCustomer jOdsCustomerClass = new jOdsCustomer();

		int exitCode = jOdsCustomerClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jOdsCustomer.class.getClassLoader()
					.getResourceAsStream("icommerce_reporting/jodscustomer_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jOdsCustomer.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jOdsCustomer");
		}
...
/************************************************************************************************
 * 293731 characters generated by Talend Open Studio for Data Integration on the
 * September 11, 2023 3:00:09 PM CEST
 ************************************************************************************************/