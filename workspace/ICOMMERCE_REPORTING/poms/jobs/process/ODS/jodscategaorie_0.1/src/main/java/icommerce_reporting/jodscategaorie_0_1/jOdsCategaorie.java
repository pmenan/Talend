...
package icommerce_reporting.jodscategaorie_0_1;
 ...
 * @status
 */
public class jOdsCategaorie implements TalendJob {
	...
	private final String jobName = "jOdsCategaorie";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					jOdsCategaorie.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jOdsCategaorie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie.length) {
					if (length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie.length == 0) {
						commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[1024];
					} else {
						commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie, 0, length);
				strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCategaorie) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					System.err.println("aucun fichier trouvé dans le répertoire " + context.projectFolder
							+ TalendDate.getDate("YYYYMMDD"));

					globalMap.put("tDie_1_DIE_MESSAGE", "aucun fichier trouvé dans le répertoire "
							+ context.projectFolder + TalendDate.getDate("YYYYMMDD"));
					globalMap.put("tDie_1_DIE_MESSAGES", "aucun fichier trouvé dans le répertoire "
							+ context.projectFolder + TalendDate.getDate("YYYYMMDD"));
	...
	public static class insertNewValueCategorieStruct
			implements routines.system.IPersistableRow<insertNewValueCategorieStruct> {
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jOdsCategaorie = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?)";
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"LB_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_CATEGORIE\" = ?";
...
// ###############################
				...
				java.sql.PreparedStatement pstmt_tDBOutput_5 = conn_tDBOutput_5
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_5
								+ "\" WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?");
				...
				String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5
						+ "\" SET \"LB_MESSAGE_REJET\" = ?,\"LB_NOM_FLUX\" = ?,\"DT_REJET\" = ?,\"LB_JOB_NAME\" = ? WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?";
...
// Start of branch "categorie"
							if (categorie != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "categorie");
								}

								row5 = null;
								row2 = null;
								Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
								ope_tFilterRow_1.matches((// code sample : use categorie to define the condition.
// categorie.columnName1.equals("foo") ||!(categorie.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
								!categorie.CD_CATEGORIE.isEmpty() && !categorie.LB_CATEGORIE.isEmpty()),
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row3.LB_CATEGORIE = row2.LB_CATEGORIE;
										...
										row6.LB_CATEGORIE = row2.LB_CATEGORIE;
...
// Start of branch "row3"
									if (row3 != null) {
										...
										if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G
											...
											// 'row4' and it contains more one result from keys : row4.CD_CATEGORIE = '"
											// + row4HashKey.CD_CATEGORIE + "'");
										} // G 071
...
// # Filter conditions 
												...
												!row3.LB_CATEGORIE.equals(row4.LB_CATEGORIE)
													...
													updateBLCurrent_tmp.LB_CATEGORIE = row4.LB_CATEGORIE;
...
// # Filter conditions 
												...
												!row3.LB_CATEGORIE.equals(row4.LB_CATEGORIE)
													...
													insertNewValueCategorie_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILE"));
													insertNewValueCategorie_tmp.DT_INSERTION = TalendDate
															.getCurrentDate();
...
// # Filter conditions 
											if (rejectedInnerJoin_tMap_2) {
												...
												insertCategorie_tmp.LB_NOM_FICHIER = ((String) globalMap
														.get("tFileList_1_CURRENT_FILE"));
...
// Start of branch "insertCategorie"
										if (insertCategorie != null) {
											...
											if (execStat) {
												runStat.updateStatOnConnection(iterateId, 1, 1, "insertCategorie");
											}
											...
											if (insertCategorie.CD_CATEGORIE == null) {
												...
												pstmt_tDBOutput_1.setString(1, insertCategorie.CD_CATEGORIE);
											}

											if (insertCategorie.LB_CATEGORIE == null) {
												pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(2, insertCategorie.LB_CATEGORIE);
											}

											if (insertCategorie.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_1.setString(3, insertCategorie.LB_NOM_FICHIER);
											}

											if (insertCategorie.DT_INSERTION != null) {
												pstmt_tDBOutput_1.setTimestamp(4,
														new java.sql.Timestamp(insertCategorie.DT_INSERTION.getTime()));
											} else {
											...
											if (insertCategorie.LB_JOB_NAME == null) {
												...
												pstmt_tDBOutput_1.setString(6, insertCategorie.LB_JOB_NAME);
											}
...
// Start of branch "updateBLCurrent"
										if (updateBLCurrent != null) {
											...
											if (updateBLCurrent.LB_CATEGORIE == null) {
												pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(1, updateBLCurrent.LB_CATEGORIE);
											}

											if (updateBLCurrent.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(2, updateBLCurrent.LB_NOM_FICHIER);
											}
											...
											pstmt_tDBOutput_2.setInt(4, updateBLCurrent.BL_LIGNE_ACTIVE);

											if (updateBLCurrent.LB_JOB_NAME == null) {
												pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(5, updateBLCurrent.LB_JOB_NAME);
											}

											if (updateBLCurrent.CD_CATEGORIE == null) {
												pstmt_tDBOutput_2.setNull(6 + count_tDBOutput_2,
														java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_2.setString(6 + count_tDBOutput_2,
														updateBLCurrent.CD_CATEGORIE);
											}
...
// Start of branch "insertNewValueCategorie"
										if (insertNewValueCategorie != null) {
											...
											if (insertNewValueCategorie.CD_CATEGORIE == null) {
												...
												pstmt_tDBOutput_3.setString(1, insertNewValueCategorie.CD_CATEGORIE);
											}

											if (insertNewValueCategorie.LB_CATEGORIE == null) {
												pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(2, insertNewValueCategorie.LB_CATEGORIE);
											}

											if (insertNewValueCategorie.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(3, insertNewValueCategorie.LB_NOM_FICHIER);
											}

											if (insertNewValueCategorie.DT_INSERTION != null) {
												pstmt_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(
														insertNewValueCategorie.DT_INSERTION.getTime()));
											} else {
												pstmt_tDBOutput_3.setNull(4, java.sql.Types.TIMESTAMP);
											}

											pstmt_tDBOutput_3.setInt(5, insertNewValueCategorie.BL_LIGNE_ACTIVE);

											if (insertNewValueCategorie.LB_JOB_NAME == null) {
												pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_3.setString(6, insertNewValueCategorie.LB_JOB_NAME);
											}
...
// # Output table : 'insertDuplicate'
											insertDuplicate_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILEPATH"));
											insertDuplicate_tmp.LB_NOM_FICHIER = ((String) globalMap
													.get("tFileList_1_CURRENT_FILE"));
											insertDuplicate_tmp.NUM_LIGNE_REJET = row6.NUM_LIGNE;
											insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_CATEGORIE + '|'
													+ row6.LB_CATEGORIE;
											insertDuplicate_tmp.LB_MESSAGE_REJET = "valeur en double";
...
// Start of branch "insertDuplicate"
										if (insertDuplicate != null) {
											...
											if (execStat) {
												runStat.updateStatOnConnection(iterateId, 1, 1, "insertDuplicate");
											}
											...
											if (insertDuplicate.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_5.setString(1, insertDuplicate.LB_CHEMIN_FICHIER);
											}

											if (insertDuplicate.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_5.setString(2, insertDuplicate.LB_NOM_FICHIER);
											}
											...
											if (insertDuplicate.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_5.setString(4, insertDuplicate.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_5 > 0) {
												if (insertDuplicate.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_5.setString(1,
															insertDuplicate.LB_MESSAGE_REJET);
												}

												if (insertDuplicate.LB_NOM_FLUX == null) {
													pstmtUpdate_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_5.setString(2, insertDuplicate.LB_NOM_FLUX);
												}

												if (insertDuplicate.DT_REJET != null) {
													pstmtUpdate_tDBOutput_5.setTimestamp(3,
															new java.sql.Timestamp(insertDuplicate.DT_REJET.getTime()));
												} else {
												...
												if (insertDuplicate.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_5.setString(4, insertDuplicate.LB_JOB_NAME);
												}

												if (insertDuplicate.LB_CHEMIN_FICHIER == null) {
													pstmtUpdate_tDBOutput_5.setNull(5 + count_tDBOutput_5,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_5.setString(5 + count_tDBOutput_5,
															insertDuplicate.LB_CHEMIN_FICHIER);
												}

												if (insertDuplicate.LB_NOM_FICHIER == null) {
													pstmtUpdate_tDBOutput_5.setNull(6 + count_tDBOutput_5,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_5.setString(6 + count_tDBOutput_5,
															insertDuplicate.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_5.setInt(7 + count_tDBOutput_5,
														insertDuplicate.NUM_LIGNE_REJET);

												if (insertDuplicate.LB_LIGNE_REJET == null) {
													pstmtUpdate_tDBOutput_5.setNull(8 + count_tDBOutput_5,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_5.setString(8 + count_tDBOutput_5,
															insertDuplicate.LB_LIGNE_REJET);
												}

												try {

													updatedCount_tDBOutput_5 = updatedCount_tDBOutput_5
															+ pstmtUpdate_tDBOutput_5.executeUpdate();
													nb_line_tDBOutput_5++;
												...
												if (insertDuplicate.LB_LIGNE_REJET == null) {
													...
													pstmtInsert_tDBOutput_5.setString(4,
															insertDuplicate.LB_LIGNE_REJET);
												}
												...
												if (insertDuplicate.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_5.setString(6, insertDuplicate.LB_NOM_FLUX);
												}

												if (insertDuplicate.DT_REJET != null) {
													pstmtInsert_tDBOutput_5.setTimestamp(7,
															new java.sql.Timestamp(insertDuplicate.DT_REJET.getTime()));
												} else {
												...
												if (insertDuplicate.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_5.setString(8, insertDuplicate.LB_JOB_NAME);
												}

												try {

													insertedCount_tDBOutput_5 = insertedCount_tDBOutput_5
															+ pstmtInsert_tDBOutput_5.executeUpdate();
													nb_line_tDBOutput_5++;
...
// # Output table : 'insertReject'
										insertReject_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILEPATH"));
										insertReject_tmp.LB_NOM_FICHIER = ((String) globalMap
												.get("tFileList_1_CURRENT_FILE"));
										insertReject_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE;
										insertReject_tmp.LB_LIGNE_REJET = row5.CD_CATEGORIE + '|' + row5.LB_CATEGORIE;
										insertReject_tmp.LB_MESSAGE_REJET = "valeur nulles pour certaines colonnes";
...
// Start of branch "insertReject"
									if (insertReject != null) {
										...
										if (insertReject.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_4.setString(1, insertReject.LB_CHEMIN_FICHIER);
										}

										if (insertReject.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(2, insertReject.LB_NOM_FICHIER);
										}
										...
										if (insertReject.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_4.setString(4, insertReject.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_4 > 0) {
											if (insertReject.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_4.setString(1, insertReject.LB_MESSAGE_REJET);
											}

											if (insertReject.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_4.setString(2, insertReject.LB_NOM_FLUX);
											}

											if (insertReject.DT_REJET != null) {
												pstmtUpdate_tDBOutput_4.setTimestamp(3,
														new java.sql.Timestamp(insertReject.DT_REJET.getTime()));
											} else {
											...
											if (insertReject.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_4.setString(4, insertReject.LB_JOB_NAME);
											}

											if (insertReject.LB_CHEMIN_FICHIER == null) {
												pstmtUpdate_tDBOutput_4.setNull(5 + count_tDBOutput_4,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_4.setString(5 + count_tDBOutput_4,
														insertReject.LB_CHEMIN_FICHIER);
											}

											if (insertReject.LB_NOM_FICHIER == null) {
												pstmtUpdate_tDBOutput_4.setNull(6 + count_tDBOutput_4,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_4.setString(6 + count_tDBOutput_4,
														insertReject.LB_NOM_FICHIER);
											}

											pstmtUpdate_tDBOutput_4.setInt(7 + count_tDBOutput_4,
													insertReject.NUM_LIGNE_REJET);

											if (insertReject.LB_LIGNE_REJET == null) {
												pstmtUpdate_tDBOutput_4.setNull(8 + count_tDBOutput_4,
														java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_4.setString(8 + count_tDBOutput_4,
														insertReject.LB_LIGNE_REJET);
											}
											...
											if (insertReject.LB_CHEMIN_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_4.setString(1, insertReject.LB_CHEMIN_FICHIER);
											}

											if (insertReject.LB_NOM_FICHIER == null) {
												pstmtInsert_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_4.setString(2, insertReject.LB_NOM_FICHIER);
											}
											...
											if (insertReject.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_4.setString(4, insertReject.LB_LIGNE_REJET);
											}

											if (insertReject.LB_MESSAGE_REJET == null) {
												pstmtInsert_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_4.setString(5, insertReject.LB_MESSAGE_REJET);
											}

											if (insertReject.LB_NOM_FLUX == null) {
												pstmtInsert_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_4.setString(6, insertReject.LB_NOM_FLUX);
											}
											...
											if (insertReject.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_4.setString(8, insertReject.LB_JOB_NAME);
											}
...
// ###############################      
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(insertCategorie,updateBLCurrent,insertNewValueCategorie)
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Nombre de lignes en double                    : "
						+ ((Integer) globalMap.get("tUniqRow_1_NB_DUPLICATES")));
				System.out.println("-----------------------------------------------------------------------------");
	...
	public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_2 = "jdbc:postgresql://" + context.servverName + ":" + context.port + "/"
						+ context.database;
				...
				String sharedConnectionName_tDBConnection_2 = "VENTES_ODS";
				...
				globalMap.put("schema_" + "tDBConnection_2", context.schema_ods);
	...
	public void tSetGlobalVar_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("nom_flux", "CATEGORY");
	...
	public static void main(String[] args) {
		final jOdsCategaorie jOdsCategaorieClass = new jOdsCategaorie();

		int exitCode = jOdsCategaorieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jOdsCategaorie.class.getClassLoader().getResourceAsStream(
					"icommerce_reporting/jodscategaorie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jOdsCategaorie.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : jOdsCategaorie");
		}
...
/************************************************************************************************
 * 270284 characters generated by Talend Open Studio for Data Integration on the
 * September 11, 2023 2:59:41 PM CEST
 ************************************************************************************************/