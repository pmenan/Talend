...
package icommerce_reporting.jmovefile_0_1;
...
/**
 * Job: jMoveFile Purpose: préparer les fichiers pour les jobs ODS<br>
 * Description: préparer les fichiers pour les jobs ODS <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class jMoveFile implements TalendJob {
	...
	private final String jobName = "jMoveFile";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jMoveFile.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_ICOMMERCE_REPORTING_jMoveFile = new byte[0];
		static byte[] commonByteArray_ICOMMERCE_REPORTING_jMoveFile = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ICOMMERCE_REPORTING_jMoveFile.length) {
					if (length < 1024 && commonByteArray_ICOMMERCE_REPORTING_jMoveFile.length == 0) {
						commonByteArray_ICOMMERCE_REPORTING_jMoveFile = new byte[1024];
					} else {
						commonByteArray_ICOMMERCE_REPORTING_jMoveFile = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ICOMMERCE_REPORTING_jMoveFile, 0, length);
				strReturn = new String(commonByteArray_ICOMMERCE_REPORTING_jMoveFile, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ICOMMERCE_REPORTING_jMoveFile) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				maskList_tFileList_1.add(context.masqueFichier);
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					String desDirName_tFileCopy_1 = context.projectFolder + TalendDate.getDate("YYYYMMDD");

					String desFileName_tFileCopy_1 = "ICOM_" + TalendDate.getDate("YYYYMMDD") + '_'
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("---------------------------------------------");
				System.out.println("Nombre de fichiers copiés : " + ((Integer) globalMap.get("tFileList_1_NB_FILE")));
				System.out.println(
						"Répertoire source : " + ((String) globalMap.get("tFileList_1_CURRENT_FILEDIRECTORY")));
				System.out
						.println("Répertoire destination : " + context.projectFolder + TalendDate.getDate("YYYYMMDD"));
	...
	public void tFileList_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_2 = context.projectFolder;
				...
				if (1 == ((Integer) globalMap.get("tFileList_2_NB_FILE"))) {
				...
				if (filetFileDelete_1.exists() && filetFileDelete_1.isDirectory()) {
					...
					if (dftFileDelete_1.delete(filetFileDelete_1)) {
						...
						throw new RuntimeException(
								"Directory " + filetFileDelete_1.getAbsolutePath() + " can not be deleted.");
					}
				} else {
					globalMap.put("tFileDelete_1_CURRENT_STATUS", "Path does not exist or is invalid.");
					throw new RuntimeException("Directory " + filetFileDelete_1.getAbsolutePath()
							+ " does not exist or is invalid or is not a directory.");
				}
	...
	public static void main(String[] args) {
		final jMoveFile jMoveFileClass = new jMoveFile();

		int exitCode = jMoveFileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jMoveFile.class.getClassLoader()
					.getResourceAsStream("icommerce_reporting/jmovefile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jMoveFile.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jMoveFile");
		}
...
/************************************************************************************************
 * 103298 characters generated by Talend Open Studio for Data Integration on the
 * September 11, 2023 2:54:54 PM CEST
 ************************************************************************************************/