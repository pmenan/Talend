...
package esb_webservice.routingsplitwithbeans_0_1;
...
/**
 * Job: RoutingSplitWithBeans Purpose: <br>
 * Description: <br>
 * 
...
public class RoutingSplitWithBeans extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		RoutingSplitWithBeans.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("direct:biling").routeId("RoutingSplitWithBeans_cDirect_1")
				.log(org.apache.camel.LoggingLevel.WARN, "RoutingSplit.cLog_1", "direct_a")

				.id("RoutingSplitWithBeans_cLog_1");
		from("direct:discount").routeId("RoutingSplitWithBeans_cDirect_2")
				.log(org.apache.camel.LoggingLevel.WARN, "RoutingSplit.cLog_2", "Discount Applied")

				.id("RoutingSplitWithBeans_cLog_2");
		from("direct:receipt").routeId("RoutingSplitWithBeans_cDirect_3")
				.log(org.apache.camel.LoggingLevel.WARN, "RoutingSplit.cLog_3", "direct_c ")

				.id("RoutingSplitWithBeans_cLog_3");
		from("file://" + context.dir_path + "RoutingSplit/in" + "?noop=true" + "&autoCreate=true" + "&flatten=false"
				+ "&charset=UTF-8" + "&bufferSize=128").routeId("RoutingSplitWithBeans_cFile_1")
						.to("flatpack:foo?delimiter=;&ignoreFirstRecord=true&splitRows=true")
						.id("RoutingSplitWithBeans_cMessagingEndpoint_1");
		from("flatpack:foo?delimiter=;&ignoreFirstRecord=true&splitRows=true")
				.routeId("RoutingSplitWithBeans_cMessagingEndpoint_2").setHeader("mySlip")
				.method(beans.ReadDiscount.class).id("RoutingSplitWithBeans_cSetHeader_1")
				.routingSlip(header("mySlip"), ",").id("RoutingSplitWithBeans_cRoutingSlip_1");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/routingsplitwithbeans.xml"));
				camelContext.setName("RoutingSplitWithBeans");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "RoutingSplitWithBeans");
				try {
				...
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cLog_1", "route2");
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cLog_2", "route4");
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cLog_3", "route5");
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cMessagingEndpoint_1", "route1");
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cSetHeader_1", "route10");
				targetNodeToConnectionMap.put("RoutingSplitWithBeans_cRoutingSlip_1", "route3");
	...
	public static void main(String[] args) {
		int exitCode = new RoutingSplitWithBeans().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = RoutingSplitWithBeans.class.getClassLoader().getResourceAsStream(
					"esb_webservice/routingsplitwithbeans_0_1/contexts/" + contextName + ".properties");
