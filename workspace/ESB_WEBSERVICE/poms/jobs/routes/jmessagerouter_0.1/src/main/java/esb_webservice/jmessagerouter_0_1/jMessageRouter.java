...
package esb_webservice.jmessagerouter_0_1;
...
/**
 * Job: jMessageRouter Purpose: MessageRouter EIP<br>
 * Description: Route a massage according to its content <br>
 * 
...
public class jMessageRouter extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		jMessageRouter.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("file://" + context.dir_path + "MessageRouter/in" + "?noop=false" + "&autoCreate=true" + "&flatten=false"
				+ "&charset=UTF-8" + "&bufferSize=128").routeId("jMessageRouter_cFile_1").choice()
						.id("jMessageRouter_cMessageRouter_1").when().xpath("/row/CodePostal='35324'")
						.to("file://" + context.dir_path + "MessageRouter/out/Flynn" + "?noop=true" + "&autoCreate=true"
								+ "&flatten=false" + "&bufferSize=128")
						.id("jMessageRouter_cFile_3").when().xpath("/row/CodePostal='95508'")
						.to("file://" + context.dir_path + "MessageRouter/out/Vivian" + "?noop=true"
								+ "&autoCreate=true" + "&flatten=false" + "&bufferSize=128")
						.id("jMessageRouter_cFile_2").otherwise()
						.to("file://" + context.dir_path + "MessageRouter/out/Others" + "?noop=true"
								+ "&autoCreate=true" + "&flatten=false" + "&bufferSize=128")
						.id("jMessageRouter_cFile_4");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/jmessagerouter.xml"));
				camelContext.setName("jMessageRouter");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "jMessageRouter");
				try {
				...
				targetNodeToConnectionMap.put("jMessageRouter_cMessageRouter_1", "route1");
				targetNodeToConnectionMap.put("jMessageRouter_cFile_3", "when1");
				targetNodeToConnectionMap.put("jMessageRouter_cFile_2", "when2");
				targetNodeToConnectionMap.put("jMessageRouter_cFile_4", "otherwise1");
	...
	public static void main(String[] args) {
		int exitCode = new jMessageRouter().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = jMessageRouter.class.getClassLoader()
					.getResourceAsStream("esb_webservice/jmessagerouter_0_1/contexts/" + contextName + ".properties");
