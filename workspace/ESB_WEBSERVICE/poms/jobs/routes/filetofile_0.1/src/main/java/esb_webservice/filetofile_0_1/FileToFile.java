...
package esb_webservice.filetofile_0_1;
...
/**
 * Job: FileToFile Purpose: copy a file from a source to a destination
 * folder<br>
 * Description: copy a file from a source to a destination folder <br>
 * 
...
public class FileToFile extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		FileToFile.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("file://" + context.dir_path + "FileToFile/in" + "?noop=true" + "&autoCreate=true" + "&flatten=false"
				+ "&fileName=customer_${date:now:yyyyMMdd}.txt" + "&bufferSize=128").routeId("FileToFile_cFile_1")
						.to("file://" + context.dir_path + "FileToFile/out" + "?noop=true" + "&autoCreate=true"
								+ "&flatten=false" + "&bufferSize=128")
						.id("FileToFile_cFile_2");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/filetofile.xml"));
				camelContext.setName("FileToFile");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "FileToFile");
				try {
				...
				targetNodeToConnectionMap.put("FileToFile_cFile_2", "route1");
	...
	public static void main(String[] args) {
		int exitCode = new FileToFile().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = FileToFile.class.getClassLoader()
					.getResourceAsStream("esb_webservice/filetofile_0_1/contexts/" + contextName + ".properties");
