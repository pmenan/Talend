...
package esb_webservice.jpassmessages_0_1;
...
public class jPassMessages extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		jPassMessages.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		org.talend.camel.TalendEndpoint endpoint_cTalendJob_1 = (org.talend.camel.TalendEndpoint) endpoint(
				"talend:jPassMessages/esb_webservice.di_joba_0_1.DI_jobA?context=Default&propagateHeader=false&sticky=false&componentId=cTalendJob_1");
		org.talend.camel.TalendEndpoint endpoint_cTalendJob_2 = (org.talend.camel.TalendEndpoint) endpoint(
				"talend:jPassMessages/esb_webservice.di_jobb_0_1.DI_jobB?context=Default&propagateHeader=false&sticky=false&componentId=cTalendJob_2");

		from("direct:Direct_JobA").routeId("jPassMessages_cDirect_3").to(endpoint_cTalendJob_1)
				.id("jPassMessages_cTalendJob_1")
				.log(org.apache.camel.LoggingLevel.WARN, "jPassMessages.cLog_1", "${in.body}")

				.id("jPassMessages_cLog_1");
		from("direct:Direct_JobB").routeId("jPassMessages_cDirect_4").to(endpoint_cTalendJob_2)
				.id("jPassMessages_cTalendJob_2")
				.log(org.apache.camel.LoggingLevel.WARN, "jPassMessages.cLog_1", "${in.body}")

				.id("jPassMessages_cLog_2");
		from("timer:cTimer_1" + "?delay=" + 1000).routeId("jPassMessages_cTimer_1").setBody()
				.constant("Hello from the PassMessages Route").id("jPassMessages_cSetBody_1").loadBalance().random()
				.id("jPassMessages_cLoadBalancer_1").pipeline().to("direct:Direct_JobA")
				.id("jPassMessages_cMessagingEndpoint_1").end().pipeline().to("direct:Direct_JobB")
				.id("jPassMessages_cMessagingEndpoint_2").end();
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/jpassmessages.xml"));
				camelContext.setName("jPassMessages");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "jPassMessages");
				try {
				...
				targetNodeToConnectionMap.put("jPassMessages_cTalendJob_1", "route3");
				targetNodeToConnectionMap.put("jPassMessages_cLog_1", "route5");
				targetNodeToConnectionMap.put("jPassMessages_cTalendJob_2", "route4");
				targetNodeToConnectionMap.put("jPassMessages_cLog_2", "route6");
				targetNodeToConnectionMap.put("jPassMessages_cSetBody_1", "route1");
				targetNodeToConnectionMap.put("jPassMessages_cLoadBalancer_1", "route2");
				targetNodeToConnectionMap.put("jPassMessages_cMessagingEndpoint_1", "load_balance1");
				targetNodeToConnectionMap.put("jPassMessages_cMessagingEndpoint_2", "load_balance2");
	...
	public static void main(String[] args) {
		int exitCode = new jPassMessages().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = jPassMessages.class.getClassLoader()
					.getResourceAsStream("esb_webservice/jpassmessages_0_1/contexts/" + contextName + ".properties");
