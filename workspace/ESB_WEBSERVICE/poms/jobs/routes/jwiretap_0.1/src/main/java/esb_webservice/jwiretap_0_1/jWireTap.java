...
package esb_webservice.jwiretap_0_1;
...
/**
 * Job: jWireTap Purpose: <br>
 * Description: Route a message to a distinct endpoint <br>
 * 
...
public class jWireTap extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("direct:log").routeId("jWireTap_cDirect_1")
				.log(org.apache.camel.LoggingLevel.WARN, "jWireTap.cLog_2", "My DEBUG message")

				.id("jWireTap_cLog_2");
		from("file://" + context.dir_path + "WireTap/in" + "?noop=true" + "&autoCreate=true" + "&flatten=false"
				+ "&bufferSize=128").routeId("jWireTap_cFile_1").wireTap("direct:log").copy(true)
						.id("jWireTap_cWireTap_1").end().split().xpath("root/row").id("jWireTap_cSplitter_1")
						.log(org.apache.camel.LoggingLevel.WARN, "jWireTap.cLog_1 - output client\n", "${body}")
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/jwiretap.xml"));
				camelContext.setName("jWireTap");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "jWireTap");
				try {
				...
				targetNodeToConnectionMap.put("jWireTap_cLog_2", "route3");
				targetNodeToConnectionMap.put("jWireTap_cWireTap_1", "route1");
				targetNodeToConnectionMap.put("jWireTap_cSplitter_1", "route2");
				targetNodeToConnectionMap.put("jWireTap_cLog_1", "split1");
	...
	public static void main(String[] args) {
		int exitCode = new jWireTap().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = jWireTap.class.getClassLoader()
					.getResourceAsStream("esb_webservice/jwiretap_0_1/contexts/" + contextName + ".properties");
