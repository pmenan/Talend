...
package esb_webservice.filecopy_0_1;
...
/**
 * Job: FileCopy Purpose: send a message from a source directory to a cible
 * directory<br>
 * Description: using cMessageEndPoint to send a message from a source directory
 * to a cible directory <br>
 * 
...
public class FileCopy extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("file://D:/git_repo/Talend/outFolder/ESB/routes/MessagingEndpoints?fileName=customer.txt")
				.routeId("FileCopy_cMessagingEndpoint_1")
				.to("file://D:/git_repo/Talend/outFolder/ESB/routes/MessagingEndpoints/Out")
				.id("FileCopy_cMessagingEndpoint_2");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/filecopy.xml"));
				camelContext.setName("FileCopy");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "FileCopy");
				try {
				...
				targetNodeToConnectionMap.put("FileCopy_cMessagingEndpoint_2", "route1");
	...
	public static void main(String[] args) {
		int exitCode = new FileCopy().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = FileCopy.class.getClassLoader()
					.getResourceAsStream("esb_webservice/filecopy_0_1/contexts/" + contextName + ".properties");
