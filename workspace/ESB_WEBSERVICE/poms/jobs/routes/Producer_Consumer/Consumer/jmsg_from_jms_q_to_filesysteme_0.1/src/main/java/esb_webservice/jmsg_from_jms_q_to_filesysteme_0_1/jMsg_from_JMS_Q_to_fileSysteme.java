...
package esb_webservice.jmsg_from_jms_q_to_filesysteme_0_1;
...
/**
 * Job: jMsg_from_JMS_Q_to_fileSysteme Purpose: <br>
 * Description: get messages from JMS queue and route them into file system <br>
 * 
...
public class jMsg_from_JMS_Q_to_fileSysteme extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		jMsg_from_JMS_Q_to_fileSysteme.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from("cMQConnectionFactory1:queue:InQueue")
				.routeId("jMsg_from_JMS_Q_to_fileSysteme_cJMS_1").to("file://" + context.dir_path + "JMS/InQueue"
						+ "?noop=true" + "&autoCreate=true" + "&flatten=false" + "&bufferSize=128")
				.id("jMsg_from_JMS_Q_to_fileSysteme_cFile_1");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/jmsg_from_jms_q_to_filesysteme.xml"));
				camelContext.setName("jMsg_from_JMS_Q_to_fileSysteme");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "jMsg_from_JMS_Q_to_fileSysteme");
				try {
				...
				targetNodeToConnectionMap.put("jMsg_from_JMS_Q_to_fileSysteme_cFile_1", "route1");
	...
	public static void main(String[] args) {
		int exitCode = new jMsg_from_JMS_Q_to_fileSysteme().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = jMsg_from_JMS_Q_to_fileSysteme.class.getClassLoader().getResourceAsStream(
					"esb_webservice/jmsg_from_jms_q_to_filesysteme_0_1/contexts/" + contextName + ".properties");
