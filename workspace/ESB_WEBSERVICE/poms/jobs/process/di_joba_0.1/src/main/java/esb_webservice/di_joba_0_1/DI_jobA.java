...
package esb_webservice.di_joba_0_1;
...
/**
 * Job: DI_jobA Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class DI_jobA implements TalendJob, TalendESBJob, TalendESBJobFactory {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public TalendESBJob newTalendESBJob() {
		DI_jobA talendESBJob = new DI_jobA();
	...
	private final String jobName = "DI_jobA";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DI_jobA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class DI_job_outputStruct implements routines.system.IPersistableRow<DI_job_outputStruct> {
    final static byte[] commonByteArrayLock_ESB_WEBSERVICE_DI_jobA = new byte[0];
    static byte[] commonByteArray_ESB_WEBSERVICE_DI_jobA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ESB_WEBSERVICE_DI_jobA.length) {
				if(length < 1024 && commonByteArray_ESB_WEBSERVICE_DI_jobA.length == 0) {
   					commonByteArray_ESB_WEBSERVICE_DI_jobA = new byte[1024];
				} else {
   					commonByteArray_ESB_WEBSERVICE_DI_jobA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ESB_WEBSERVICE_DI_jobA, 0, length);
			strReturn = new String(commonByteArray_ESB_WEBSERVICE_DI_jobA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ESB_WEBSERVICE_DI_jobA) {
...
DI_job_output_tmp.body = row1.body+" To job A";
 ...
 */
    ...
    public static void main(String[] args){
        final DI_jobA DI_jobAClass = new DI_jobA();

        int exitCode = DI_jobAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DI_jobA.class.getClassLoader().getResourceAsStream("esb_webservice/di_joba_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DI_jobA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DI_jobA");
        }
