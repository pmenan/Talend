...
package formation_talend.mock_job_for_guess_schema_0_1;
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("SELECT    \"" + context.Connexion_Postgres_Database + "\".\""
						+ context.Connexion_Postgres_Schema + "\".\"Clients\".\"Id\",    \""
						+ context.Connexion_Postgres_Database + "\".\"" + context.Connexion_Postgres_Schema
						+ "\".\"Clients\".\"Prenom\",    \"" + context.Connexion_Postgres_Database + "\".\""
						+ context.Connexion_Postgres_Schema + "\".\"Clients\".\"Nom\",    \""
						+ context.Connexion_Postgres_Database + "\".\"" + context.Connexion_Postgres_Schema
						+ "\".\"Clients\".\"Date_naissance\",    \"" + context.Connexion_Postgres_Database + "\".\""
						+ context.Connexion_Postgres_Schema + "\".\"Clients\".\"Code_postal\" FROM \""
						+ context.Connexion_Postgres_Database + "\".\"" + context.Connexion_Postgres_Schema
						+ "\".\"Clients\"");
				...
				String fileName = (new java.io.File(
						"C:/Talend/TOS_DI-Win32-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"formation_talend/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 54898 characters generated by Talend Open Studio for Data Integration on the
 * 25 juin 2023 20:18:20 CEST
 ************************************************************************************************/