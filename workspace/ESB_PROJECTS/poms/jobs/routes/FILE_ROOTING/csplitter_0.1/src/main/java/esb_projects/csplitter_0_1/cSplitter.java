...
package esb_projects.csplitter_0_1;
...
/**
 * Job: cSplitter Purpose: Splitt a XML file<br>
 * Description: Splitt a XML file into many fille <br>
 * 
...
public class cSplitter extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/csplitter.xml"));
				camelContext.setName("cSplitter");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "cSplitter");
				try {
	...
	public static void main(String[] args) {
		int exitCode = new cSplitter().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = cSplitter.class.getClassLoader()
					.getResourceAsStream("esb_projects/csplitter_0_1/contexts/" + contextName + ".properties");
