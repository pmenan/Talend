...
package esb_projects.cfilerouting_0_1;
...
/**
 * Job: cFileRouting Purpose: Route file<br>
 * Description: visit a local file directory and send the files in the directory
 * to an output cFile component which writes the files in another directory <br>
 * 
...
public class cFileRouting extends org.apache.camel.builder.RouteBuilder implements TalendESBRoute {
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		cFileRouting.arguments = arguments;
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/cfilerouting.xml"));
				camelContext.setName("cFileRouting");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "cFileRouting");
				try {
				...
				targetNodeToConnectionMap.put("cFileRouting_cFile_2", "route1");
	...
	public static void main(String[] args) {
		int exitCode = new cFileRouting().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = cFileRouting.class.getClassLoader()
					.getResourceAsStream("esb_projects/cfilerouting_0_1/contexts/" + contextName + ".properties");
