...
package formation_talend.jfile_0_1;
...
/**
 * Job: jfile Purpose: créer un fichier delimité dans les metadata<br>
 * Description: créer un fichier delimité dans les metadata <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class jfile implements TalendJob {
	...
	private final String jobName = "jfile";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jfile.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_FORMATION_TALEND_jfile = new byte[0];
		static byte[] commonByteArray_FORMATION_TALEND_jfile = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FORMATION_TALEND_jfile.length) {
					if (length < 1024 && commonByteArray_FORMATION_TALEND_jfile.length == 0) {
						commonByteArray_FORMATION_TALEND_jfile = new byte[1024];
					} else {
						commonByteArray_FORMATION_TALEND_jfile = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FORMATION_TALEND_jfile, 0, length);
				strReturn = new String(commonByteArray_FORMATION_TALEND_jfile, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_TALEND_jfile) {
	...
	public void tFileInputXML_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_3.addRow(new String[] { "Id", "Nom", "date_creation", "CodePostal", });
...
///////////////////////    			
				...
				try {
					filename_tFileInputXML_1 = "C:/Users/menan/OneDrive/Bureau/TALEND/DOSSIER_TALEND/Inputs/individus.xml";
					...
					class XPathUtil_tFileInputXML_1 {
						...
						public void initXPaths_0(java.util.Map<Integer, org.dom4j.XPath> xpaths,
							...
							org.dom4j.XPath xpath_0 = org.dom4j.DocumentHelper
									.createXPath(nsTool.addDefaultNSPrefix("Id", "/root/row"));
							...
							org.dom4j.XPath xpath_2 = org.dom4j.DocumentHelper
									.createXPath(nsTool.addDefaultNSPrefix("date_creation", "/root/row"));
							xpath_2.setNamespaceURIs(xmlNameSpaceMap);

							xpaths.put(2, xpath_2);

							org.dom4j.XPath xpath_3 = org.dom4j.DocumentHelper
									.createXPath(nsTool.addDefaultNSPrefix("CodePostal", "/root/row"));
					...
					for (org.dom4j.Node temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						...
						try {
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row3.Id = ParserUtils.parseTo_Integer(str_tFileInputXML_1);
							}
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row3.date_creation = str_tFileInputXML_1;
							}
							...
							if (xml_api_tFileInputXML_1.isDefNull(node_tFileInputXML_1)) {
								...
								row3.CodePostal = ParserUtils.parseTo_Integer(str_tFileInputXML_1);
							}
...
///////////////////////		
							...
							if (row3.Id != null) { //
								row_tLogRow_3[0] = String.valueOf(row3.Id);

							} //

							if (row3.Nom != null) { //
								row_tLogRow_3[1] = String.valueOf(row3.Nom);

							} //

							if (row3.date_creation != null) { //
								row_tLogRow_3[2] = String.valueOf(row3.date_creation);

							} //

							if (row3.CodePostal != null) { //
								row_tLogRow_3[3] = String.valueOf(row3.CodePostal);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final jfile jfileClass = new jfile();

		int exitCode = jfileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jfile.class.getClassLoader()
					.getResourceAsStream("formation_talend/jfile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jfile.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jfile");
		}
...
/************************************************************************************************
 * 51694 characters generated by Talend Open Studio for Data Integration on the
 * August 12, 2023 12:50:51 AM CEST
 ************************************************************************************************/