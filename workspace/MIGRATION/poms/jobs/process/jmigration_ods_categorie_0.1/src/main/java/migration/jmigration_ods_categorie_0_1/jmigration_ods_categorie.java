...
package migration.jmigration_ods_categorie_0_1;
...
/**
 * Job: jmigration_ods_categorie Purpose: migration des données du fichier
 * categorie vers la table categorie<br>
 * Description: migration des données du fichier categorie vers la table
 * categorie <br>
 * 
 ...
 * @status
 */
public class jmigration_ods_categorie implements TalendJob {
	...
	private final String jobName = "jmigration_ods_categorie";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					jmigration_ods_categorie.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jmigration_ods_categorie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MIGRATION_jmigration_ods_categorie = new byte[0];
		static byte[] commonByteArray_MIGRATION_jmigration_ods_categorie = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIGRATION_jmigration_ods_categorie.length) {
					if (length < 1024 && commonByteArray_MIGRATION_jmigration_ods_categorie.length == 0) {
						commonByteArray_MIGRATION_jmigration_ods_categorie = new byte[1024];
					} else {
						commonByteArray_MIGRATION_jmigration_ods_categorie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIGRATION_jmigration_ods_categorie, 0, length);
				strReturn = new String(commonByteArray_MIGRATION_jmigration_ods_categorie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIGRATION_jmigration_ods_categorie) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "CD_CATEGORIE", "LB_CATEGORIE", "COMMENTAIRE", });
...
///////////////////////    			
				...
				String dbquery_tDBInput_1 = "SELECT CD_CATEGORIE, LB_CATEGORIE\nFROM categorie";
...
///////////////////////		
						...
						if (row2.CD_CATEGORIE != null) { //
							row_tLogRow_1[0] = String.valueOf(row2.CD_CATEGORIE);

						} //

						if (row2.LB_CATEGORIE != null) { //
							row_tLogRow_1[1] = String.valueOf(row2.LB_CATEGORIE);

						} //

						if (row2.COMMENTAIRE != null) { //
							row_tLogRow_1[2] = String.valueOf(row2.COMMENTAIRE);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final jmigration_ods_categorie jmigration_ods_categorieClass = new jmigration_ods_categorie();

		int exitCode = jmigration_ods_categorieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jmigration_ods_categorie.class.getClassLoader().getResourceAsStream(
					"migration/jmigration_ods_categorie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jmigration_ods_categorie.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : jmigration_ods_categorie");
		}
...
/************************************************************************************************
 * 77773 characters generated by Talend Open Studio for Data Integration on the
 * 19 juillet 2023 23:47:29 CEST
 ************************************************************************************************/