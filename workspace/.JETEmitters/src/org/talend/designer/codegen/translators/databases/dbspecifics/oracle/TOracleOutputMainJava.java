...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_39 = NL + NL + "            if(dbschema_";
  protected final String TEXT_40 = " == null || dbschema_";
  protected final String TEXT_41 = ".trim().length() == 0) {" + NL + "                tableName_";
  ...
  protected final String TEXT_48 = NL + "  \ttableName_";
  protected final String TEXT_49 = " += \" \" +";
  protected final String TEXT_50 = ";";
  protected final String TEXT_51 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_63 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_64 = NL + "                              stmtCreate_";
  protected final String TEXT_65 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_66 = "));";
  protected final String TEXT_67 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_68 = " = ";
  protected final String TEXT_69 = ";" + NL + "\t                    if (";
  protected final String TEXT_70 = ") {" + NL + "\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_71 = ".getColumnCount(); i++) {" + NL + "\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_72 = ".getColumnMetadata(i);" + NL + "\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_73 = ".execute(((\"";
  protected final String TEXT_74 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_82 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_83 = ";" + NL + "                    if (";
  protected final String TEXT_84 = ") {" + NL + "                        for (int i = 0; i < dynamic_";
  protected final String TEXT_85 = ".getColumnCount(); i++) {" + NL + "                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_86 = ".getColumnMetadata(i);" + NL + "                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_87 = NL;
  protected final String TEXT_88 = NL + "                    String keyCheckTable_";
  protected final String TEXT_89 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_94 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_95 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_96 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_97 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_98 = ")== null){//}";
  protected final String TEXT_99 = NL + "                                boolean whetherExist_";
  protected final String TEXT_100 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_101 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_105 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_106 = NL + "                                ";
  protected final String TEXT_107 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_108 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_109 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_110 = " = tableNameForSearch_";
  protected final String TEXT_111 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_112 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_113 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_114 = " = dbMetaData_";
  protected final String TEXT_115 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_116 = ", tableNameForSearch_";
  protected final String TEXT_117 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_118 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_119 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_120 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_121 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_122 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_123 = " = rsTable_";
  protected final String TEXT_124 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_125 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_126 = ".equals";
  protected final String TEXT_127 = "IgnoreCase";
  protected final String TEXT_128 = "(";
  protected final String TEXT_129 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_133 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_134 = "((";
  protected final String TEXT_135 = ") || (dbschema_";
  protected final String TEXT_136 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_137 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_138 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_139 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_140 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_141 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_142 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_143 = " = stmtSchema_";
  protected final String TEXT_144 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_145 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_146 = " = rsSchema_";
  protected final String TEXT_147 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_148 = ".toLowerCase()";
  protected final String TEXT_149 = ") || ((dbschema_";
  protected final String TEXT_150 = " ==null || dbschema_";
  protected final String TEXT_151 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_152 = "(schema_";
  protected final String TEXT_153 = NL + "                                String tableForSearch_";
  protected final String TEXT_154 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_155 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_156 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_157 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_158 = " =  tableForSearch_";
  protected final String TEXT_159 = ".substring(1,tableForSearch_";
  protected final String TEXT_160 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_161 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_162 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_163 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_164 = ".getTables(null, conn_";
  protected final String TEXT_165 = ".getSchema(), tableForSearch_";
  protected final String TEXT_166 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_167 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_168 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_169 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_170 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_171 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_172 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_173 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_174 = ".getTables(";
  protected final String TEXT_175 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_176 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_177 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_178 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_183 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_184 = NL + "                                                      stmtCreate_";
  protected final String TEXT_185 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_186 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_187 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_188 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_189 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  protected final String TEXT_190 = NL + "                                        stmtCreate_";
  protected final String TEXT_191 = NL + "                                    }" + NL + "                                }";
  protected final String TEXT_192 = NL + "                                if(whetherExist_";
  protected final String TEXT_193 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_198 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_199 = NL + "                                                  stmtCreate_";
  protected final String TEXT_200 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_201 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_202 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_203 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_204 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_205 = NL + "                                    stmtCreate_";
  protected final String TEXT_206 = NL + "                                }";
  protected final String TEXT_207 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_208 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_209 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_210 = NL + "                              stmtClear_";
  protected final String TEXT_211 = NL + "                stmtClear_";
  protected final String TEXT_212 = ".executeUpdate(\"";
  protected final String TEXT_213 = "\");";
  protected final String TEXT_214 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_215 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_216 = NL + "                              stmtTruncCount_";
  protected final String TEXT_217 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_218 = " = stmtTruncCount_";
  protected final String TEXT_219 = ".executeQuery(\"";
  protected final String TEXT_220 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_221 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_222 = " = rsTruncCount_";
  protected final String TEXT_223 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_224 = NL + "                              stmtTrunc_";
  protected final String TEXT_225 = NL + "                conn_";
  protected final String TEXT_226 = NL + "                stmtTrunc_";
  protected final String TEXT_227 = NL + "                    if(!conn_";
  protected final String TEXT_228 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_229 = ".commit();" + NL + "                    }";
  protected final String TEXT_230 = NL + "                deletedCount_";
  protected final String TEXT_231 = " += rsTruncCountNumber_";
  protected final String TEXT_232 = ";" + NL + "            }";
  protected final String TEXT_233 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_234 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_235 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_236 = NL + "                while(rsTruncCount_";
  protected final String TEXT_237 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_238 = " += rsTruncCount_";
  protected final String TEXT_239 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_240 = NL + "                            String insert_";
  protected final String TEXT_241 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_242 = " + \" (";
  protected final String TEXT_243 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_248 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_249 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_250 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_251 = " = new StringBuffer(insert_";
  protected final String TEXT_252 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_253 = ".insert(insert_";
  protected final String TEXT_254 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_255 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_256 = " =insertStringBuffer_";
  protected final String TEXT_257 = ".toString(); ";
  protected final String TEXT_258 = "    " + NL;
  protected final String TEXT_259 = NL + "                        pstmt_";
  protected final String TEXT_260 = ".prepareStatement(insert_";
  protected final String TEXT_261 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_262 = "\", pstmt_";
  protected final String TEXT_263 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_264 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_265 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_266 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_267 = ");" + NL + "                            resourceMap.put(\"pstmt_";
  protected final String TEXT_268 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_269 = ", pstmt_";
  protected final String TEXT_270 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_271 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_272 = ");" + NL + "                        }";
  protected final String TEXT_273 = NL + "                            String update_";
  protected final String TEXT_274 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_275 = " + \" SET ";
  protected final String TEXT_276 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_277 = "+\" WHERE ";
  protected final String TEXT_278 = "\";";
  protected final String TEXT_279 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_280 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_281 = " = new StringBuffer(update_";
  protected final String TEXT_282 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_283 = ".insert(update_";
  protected final String TEXT_284 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_285 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_286 = " =updateStringBuffer_";
  protected final String TEXT_287 = NL + "                    pstmt_";
  protected final String TEXT_288 = ".prepareStatement(update_";
  protected final String TEXT_289 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_290 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_291 = " + \" WHERE ";
  protected final String TEXT_292 = "\");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_293 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_294 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_295 = "\", pstmtInsert_";
  protected final String TEXT_296 = NL + "                    pstmtUpdate_";
  protected final String TEXT_297 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_298 = "\", pstmtUpdate_";
  protected final String TEXT_299 = NL + "                    String delete_";
  protected final String TEXT_300 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_301 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_302 = " = new StringBuffer(delete_";
  protected final String TEXT_303 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_304 = ".insert(delete_";
  protected final String TEXT_305 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_306 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_307 = " =deleteStringBuffer_";
  protected final String TEXT_308 = ".toString();  ";
  protected final String TEXT_309 = NL + "                    pstmt_";
  protected final String TEXT_310 = ".prepareStatement(delete_";
  protected final String TEXT_311 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_312 = " = insert_";
  protected final String TEXT_313 = ".split(\"\\\\?\");";
  protected final String TEXT_314 = NL + "\t\t\tupdate_";
  protected final String TEXT_315 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_316 = " = update_";
  protected final String TEXT_317 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_318 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_319 = NL + "\t\t\tdelete_";
  protected final String TEXT_320 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_321 = " = delete_";
  protected final String TEXT_322 = NL + "\t\t\treplace_";
  protected final String TEXT_323 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_324 = " = replace_";
  protected final String TEXT_325 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_326 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_327 = " = insertIgnore_";
  protected final String TEXT_328 = NL + "        }";
  protected final String TEXT_329 = NL + "        query_";
  protected final String TEXT_330 = " = new StringBuffer(\"\");";
  protected final String TEXT_331 = NL + "                commitEvery_";
  protected final String TEXT_332 = " = buffersSize_";
  protected final String TEXT_333 = NL + "            batchSize_";
  protected final String TEXT_334 = NL + "        whetherReject_";
  protected final String TEXT_335 = " = false;";
  protected final String TEXT_336 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_337 = NL + "                            // TODO error: ";
  protected final String TEXT_338 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_339 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_340 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_341 = " = tGeometry_";
  protected final String TEXT_342 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_343 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_344 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_345 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_346 = "\", geometry_";
  protected final String TEXT_347 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_348 = ".expandToInclude(geometry_";
  protected final String TEXT_349 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_350 = " = geometry_";
  protected final String TEXT_351 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_352 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_353 = " = oracle_wkt_";
  protected final String TEXT_354 = ".toJGeometry(wkt_";
  protected final String TEXT_355 = ".getBytes());" + NL;
  protected final String TEXT_356 = NL + "                            jgeometry_";
  protected final String TEXT_357 = ".setSRID(";
  protected final String TEXT_358 = ".setObject(";
  protected final String TEXT_359 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_360 = ", conn_";
  protected final String TEXT_361 = NL + "                        query_";
  protected final String TEXT_362 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_363 = ",";
  protected final String TEXT_364 = ", ";
  protected final String TEXT_365 = ",insertSQLSplits_";
  protected final String TEXT_366 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_367 = NL + "                globalMap.put(\"";
  protected final String TEXT_368 = "_QUERY\", query_";
  protected final String TEXT_369 = ".toString().trim());";
  protected final String TEXT_370 = NL + "                pstmt_";
  protected final String TEXT_371 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_372 = "++;";
  protected final String TEXT_373 = NL + "                batchSizeCounter_";
  protected final String TEXT_374 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_375 = NL + "                    insertedCount_";
  protected final String TEXT_376 = " = insertedCount_";
  protected final String TEXT_377 = " + pstmt_";
  protected final String TEXT_378 = ".executeUpdate();";
  protected final String TEXT_379 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_380 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_381 = " = true;";
  protected final String TEXT_382 = NL + "                        throw(e_";
  protected final String TEXT_383 = " = new ";
  protected final String TEXT_384 = "Struct();";
  protected final String TEXT_385 = NL + "                                ";
  protected final String TEXT_386 = NL + "                            rejectedCount_";
  protected final String TEXT_387 = " = rejectedCount_";
  protected final String TEXT_388 = " + 1;";
  protected final String TEXT_389 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_390 = ").getSQLState();";
  protected final String TEXT_391 = ".errorMessage = e_";
  protected final String TEXT_392 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_393 = NL + "                            System.err.print(e_";
  protected final String TEXT_394 = ".getMessage());";
  protected final String TEXT_395 = NL + "                }";
  protected final String TEXT_396 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_397 = ",updateSQLSplits_";
  protected final String TEXT_398 = NL + "                    int count_";
  protected final String TEXT_399 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_405 = " = updatedCount_";
  protected final String TEXT_406 = NL + "            int checkCount_";
  protected final String TEXT_407 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_408 = " = pstmt_";
  protected final String TEXT_409 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_410 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_411 = " = rs_";
  protected final String TEXT_412 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_413 = " > 0) {";
  protected final String TEXT_414 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_415 = NL + "                        int count_";
  protected final String TEXT_416 = ", pstmtUpdate_";
  protected final String TEXT_417 = NL + "                                    query_";
  protected final String TEXT_418 = NL + "                    globalMap.put(\"";
  protected final String TEXT_419 = NL + "                try {";
  protected final String TEXT_420 = " + pstmtUpdate_";
  protected final String TEXT_421 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_422 = NL + "                        nb_line_";
  protected final String TEXT_423 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_424 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_425 = ", pstmtInsert_";
  protected final String TEXT_426 = " + pstmtInsert_";
  protected final String TEXT_427 = NL + "                }" + NL + "            }";
  protected final String TEXT_428 = NL + "            int updateFlag_";
  protected final String TEXT_429 = " = 0;";
  protected final String TEXT_430 = NL + NL + "                    int count_";
  protected final String TEXT_431 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_432 = " = pstmtUpdate_";
  protected final String TEXT_433 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_434 = "+updateFlag_";
  protected final String TEXT_435 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_436 = " == 0) {";
  ...
  protected final String TEXT_439 = NL + "                        globalMap.put(\"";
  protected final String TEXT_440 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_441 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_442 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_443 = NL + "                    throw(e_";
  protected final String TEXT_444 = NL + "                    nb_line_";
  protected final String TEXT_445 = NL + "                        rejectedCount_";
  protected final String TEXT_446 = NL + "                        System.err.print(e_";
  protected final String TEXT_447 = NL + "            }";
  protected final String TEXT_448 = NL + "                    deletedCount_";
  protected final String TEXT_449 = " = deletedCount_";
  protected final String TEXT_450 = NL + "            if(!whetherReject_";
  protected final String TEXT_451 = ") {";
  protected final String TEXT_452 = NL + "            if (batchSize_";
  protected final String TEXT_453 = " > 0 &&  batchSize_";
  protected final String TEXT_454 = " <= batchSizeCounter_";
  protected final String TEXT_455 = ") {" + NL + "                try {";
  protected final String TEXT_456 = ".executeBatch();";
  protected final String TEXT_457 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_458 = "){" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_459 = " = e_";
  protected final String TEXT_460 = ".getNextException(),sqle_";
  protected final String TEXT_461 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_462 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_463 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_464 = " = new java.sql.SQLException(e_";
  protected final String TEXT_465 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_466 = ".getMessage(), ne_";
  protected final String TEXT_467 = ".getSQLState(), ne_";
  protected final String TEXT_468 = ".getErrorCode(), ne_";
  protected final String TEXT_469 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_470 = " = sqle_";
  protected final String TEXT_471 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_472 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t            \t";
  protected final String TEXT_473 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_474 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_475 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_476 = ");" + NL + "\t\t\t            }" + NL + "\t            \t";
  protected final String TEXT_477 = NL + "\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_478 = ");" + NL + "\t            \t";
  protected final String TEXT_479 = NL + "\t        \t}" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_480 = ".getUpdateCount();";
  protected final String TEXT_481 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_482 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_483 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_484 = " = 0;" + NL + "            }";
  protected final String TEXT_485 = NL + "                commitCounter_";
  protected final String TEXT_486 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_487 = " <= commitCounter_";
  protected final String TEXT_488 = ") {" + NL;
  protected final String TEXT_489 = NL + "                        try {";
  protected final String TEXT_490 = NL + "                            pstmt_";
  protected final String TEXT_491 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_492 = "){" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_493 = "=null;" + NL + "\t\t\t\t\t    \tString errormessage_";
  protected final String TEXT_494 = ";" + NL + "\t\t\t\t\t\t\tif (ne_";
  protected final String TEXT_495 = " != null) {" + NL + "\t\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_496 = ");" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_497 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_498 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t            \t";
  protected final String TEXT_499 = NL + "\t\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_500 = " != null) {" + NL + "\t\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_501 = ");" + NL + "\t\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t\t            \tthrow(e_";
  protected final String TEXT_502 = ");" + NL + "\t\t\t\t\t            }" + NL + "\t\t\t            \t";
  protected final String TEXT_503 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_504 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_505 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_506 = NL + "                            insertedCount_";
  protected final String TEXT_507 = NL + "                            updatedCount_";
  protected final String TEXT_508 = NL + "                            deletedCount_";
  protected final String TEXT_509 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_510 = ":0);";
  protected final String TEXT_511 = NL + "                    conn_";
  protected final String TEXT_512 = NL + "                    commitCounter_";
  protected final String TEXT_513 = "=0;" + NL + "                }";
