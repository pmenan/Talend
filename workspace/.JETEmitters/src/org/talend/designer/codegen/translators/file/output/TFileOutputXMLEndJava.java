...
public class TFileOutputXMLEndJava
{
  ...
  protected final String TEXT_21 = "+\">\");" + NL + "" + NL + "out_";
  protected final String TEXT_22 = ".newLine();" + NL;
  protected final String TEXT_23 = "\tout_";
  protected final String TEXT_24 = ".write(footers_";
  protected final String TEXT_25 = "[";
  protected final String TEXT_26 = "]);" + NL + "" + NL + "\tout_";
  protected final String TEXT_27 = ".newLine();" + NL + "\t";
  protected final String TEXT_28 = ".close();" + NL;
  protected final String TEXT_29 = NL + "\tif(currentRowCount_";
  protected final String TEXT_30 = " == 0){\t\t" + NL + "\t\tfile_";
  protected final String TEXT_31 = ".delete();" + NL + "\t}";
  protected final String TEXT_32 = "globalMap.put(\"";
  ...
  protected final String TEXT_38 = NL + "\tif(nb_line_";
