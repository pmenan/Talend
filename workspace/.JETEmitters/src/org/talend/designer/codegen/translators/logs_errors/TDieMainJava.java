...
public class TDieMainJava
{
  ...
  protected final String TEXT_19 = ") {" + NL + "\t\tlogIgnoredError(String.format(\"";
  protected final String TEXT_20 = " - tDie failed to log message due to internal error: %s\", e_";
  protected final String TEXT_21 = "), e_";
  protected final String TEXT_22 = ");" + NL + "\t}" + NL + "\t" + NL + "\tcurrentComponent = \"";
  protected final String TEXT_23 = "\";" + NL + "\tstatus = \"failure\";";
  protected final String TEXT_24 = NL + "    \terrorCode = new Integer(";
  protected final String TEXT_25 = ");" + NL + "        ((java.util.Map)threadLocal.get()).put(\"errorCode\", new Integer(";
  protected final String TEXT_26 = "));" + NL + "        ((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_27 = "_DIE_CODE\", errorCode);";
  protected final String TEXT_28 = NL + "        errorCode = new Integer(";
  ...
  protected final String TEXT_34 = " - Exiting the VM.\");" + NL + "\t";
  protected final String TEXT_35 = NL + "\tSystem.exit(";
  protected final String TEXT_36 = ");";
  protected final String TEXT_37 = NL + "\tif(true){\t" + NL + "\t    throw new TDieException();" + NL + "\t}";
