...
public class THashInputBeginJava
{
  ...
  protected final String TEXT_12 = "\");" + NL + "if(tHashFile_";
  protected final String TEXT_13 = "==null) {" + NL + "\tthrow new RuntimeException(\"The hash is not initialized : The hash must exist before you read from it\");" + NL + "}" + NL + "java.util.Iterator<";
  protected final String TEXT_14 = "Struct> iterator_";
  protected final String TEXT_15 = " = tHashFile_";
  protected final String TEXT_16 = ".iterator();" + NL + "while (iterator_";
  protected final String TEXT_17 = ".hasNext()) {";
  protected final String TEXT_18 = NL + "    ";
  protected final String TEXT_19 = "Struct next_";
  protected final String TEXT_20 = " = iterator_";
  protected final String TEXT_21 = ".next();" + NL;
  protected final String TEXT_22 = NL + "\t";
  protected final String TEXT_23 = ".";
  protected final String TEXT_24 = " = next_";
