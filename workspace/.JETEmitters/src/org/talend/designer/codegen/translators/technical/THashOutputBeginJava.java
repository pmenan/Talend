...
public class THashOutputBeginJava
{
  ...
  protected final String TEXT_22 = ");" + NL + "\t\t\t    }else{" + NL + "\t\t\t    \ttHashFile_";
  protected final String TEXT_23 = ");" + NL + "\t\t\t    }" + NL + "\t\t\t}";
  protected final String TEXT_24 = ")){" + NL + "\t\t\t\tmf_";
  protected final String TEXT_25 = "));" + NL + "\t\t\t\ttHashFile_";
  protected final String TEXT_26 = ");" + NL + "\t\t\t}";
  protected final String TEXT_27 = NL + "\t\torg.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<";
  protected final String TEXT_28 = " = null; " + NL + "\t\t//use this map to keep the present key and the previous key of AdvancedMemoryHashFile" + NL + "\t\tmf_";
  protected final String TEXT_29 = ".getKeyMap().put(\"tHashFile_";
  protected final String TEXT_30 = "_\" +pid + \"_";
  protected final String TEXT_31 = "\", \"tHashFile_";
  protected final String TEXT_32 = "\");";
  protected final String TEXT_33 = NL + "        int nb_line_";
