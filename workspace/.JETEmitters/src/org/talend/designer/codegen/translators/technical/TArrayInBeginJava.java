...
public class TArrayInBeginJava
{
  ...
  protected final String TEXT_7 = ">)globalMap.get(\"";
  protected final String TEXT_8 = "\");" + NL + "        if(list_";
  protected final String TEXT_9 = " == null) {" + NL + "            list_";
  protected final String TEXT_10 = " = new java.util.ArrayList<";
  protected final String TEXT_11 = ">();" + NL + "        }        " + NL + "        for(";
