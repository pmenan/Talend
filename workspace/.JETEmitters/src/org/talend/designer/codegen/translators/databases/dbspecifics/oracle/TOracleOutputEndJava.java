...
public class TOracleOutputEndJava
{
  ...
  protected final String TEXT_67 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\t// Create spatial index using GIST on geometry columns" + NL + "\t\t\tString createIndex_";
  protected final String TEXT_68 = " = \"CREATE INDEX \"+index_name + \" \"" + NL + "\t\t\t\t\t\t+ \"ON \" + ";
  protected final String TEXT_69 = " + \"(\" + geometryColumnName + \") \"" + NL + "\t\t\t\t\t\t+ \"INDEXTYPE IS MDSYS.SPATIAL_INDEX\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_73 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_74 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_75 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_76 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_77 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_78 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_79 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_80 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_81 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_82 = "\");" + NL + "        }";
  protected final String TEXT_83 = NL + "            try {" + NL + "            \tif (pstmt_";
  protected final String TEXT_84 = " != null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t\t\tpstmt_";
  protected final String TEXT_86 = ".executeBatch();" + NL + "\t\t\t\t\t";
  protected final String TEXT_87 = NL + "        \t    }" + NL + "            }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_88 = "){" + NL + "\t\t        java.sql.SQLException ne_";
  protected final String TEXT_89 = " = e_";
  protected final String TEXT_90 = ".getNextException(),sqle_";
  protected final String TEXT_91 = "=null;" + NL + "\t\t    \tString errormessage_";
  protected final String TEXT_92 = ";" + NL + "\t\t\t\tif (ne_";
  protected final String TEXT_93 = " != null) {" + NL + "\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\tsqle_";
  protected final String TEXT_94 = " = new java.sql.SQLException(e_";
  protected final String TEXT_95 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_96 = ".getMessage(), ne_";
  protected final String TEXT_97 = ".getSQLState(), ne_";
  protected final String TEXT_98 = ".getErrorCode(), ne_";
  protected final String TEXT_99 = ");" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_100 = " = sqle_";
  protected final String TEXT_101 = ".getMessage();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_102 = ".getMessage();" + NL + "\t\t\t\t}" + NL + "            \t";
  protected final String TEXT_103 = NL + "\t\t    \t\tif (ne_";
  protected final String TEXT_104 = " != null) {" + NL + "\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_105 = ");" + NL + "\t\t    \t\t}else{" + NL + "\t\t            \tthrow(e_";
  protected final String TEXT_106 = ");" + NL + "\t\t            }" + NL + "            \t";
  protected final String TEXT_107 = NL + "                \tSystem.err.println(errormessage_";
  protected final String TEXT_108 = ");" + NL + "            \t";
  protected final String TEXT_109 = NL + "        \t}" + NL + "        \tif (pstmt_";
  protected final String TEXT_110 = " != null) {" + NL + "            \ttmp_batchUpdateCount_";
  protected final String TEXT_111 = " = pstmt_";
  protected final String TEXT_112 = ".getUpdateCount();" + NL + "    \t    \t";
  protected final String TEXT_113 = NL + "    \t    \t\tinsertedCount_";
  protected final String TEXT_114 = NL + "    \t    \t";
  protected final String TEXT_115 = NL + "    \t    \t\tupdatedCount_";
  protected final String TEXT_116 = NL + "    \t    \t    deletedCount_";
  ...
  protected final String TEXT_123 = ".close();" + NL + "\t\t\t\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_124 = "\");" + NL + "\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_126 = NL + "        }";
  protected final String TEXT_127 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_128 = "\", true);";
  protected final String TEXT_129 = NL + "\t\tif(commitCounter_";
  ...
  protected final String TEXT_137 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_138 = "\", true);" + NL + "   \t";
  protected final String TEXT_139 = NL + NL + NL + "\t";
  protected final String TEXT_140 = NL + "\tnb_line_deleted_";
  protected final String TEXT_141 = "=nb_line_deleted_";
  protected final String TEXT_142 = "+ deletedCount_";
  protected final String TEXT_143 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_144 = "=nb_line_update_";
  protected final String TEXT_145 = " + updatedCount_";
  protected final String TEXT_146 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_147 = "=nb_line_inserted_";
  protected final String TEXT_148 = " + insertedCount_";
  protected final String TEXT_149 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_150 = "=nb_line_rejected_";
  protected final String TEXT_151 = " + rejectedCount_";
  protected final String TEXT_152 = ";" + NL + "\t";
  protected final String TEXT_153 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_154 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_155 = "_NB_LINE\",nb_line_";
  protected final String TEXT_156 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_157 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_158 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_159 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_160 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_161 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_162 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_166 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_167 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_168 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_169 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_170 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_174 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  ...
  protected final String TEXT_179 = "_NB_LINE_REJECTED\", nb_line_rejected_";
