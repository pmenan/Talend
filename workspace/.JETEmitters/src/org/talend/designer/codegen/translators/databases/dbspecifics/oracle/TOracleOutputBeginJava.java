...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_43 = " < 1) {" + NL + "                throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "            }";
  protected final String TEXT_44 = NL + "            int deleteKeyCount_";
  protected final String TEXT_45 = ";" + NL + "            if(deleteKeyCount_";
  protected final String TEXT_46 = " < 1) {" + NL + "                throw new RuntimeException(\"For delete, the schema must have a key\");" + NL + "            }";
  ...
  protected final String TEXT_52 = " = 0;" + NL + "" + NL + "    int tmp_batchUpdateCount_";
  protected final String TEXT_53 = " = 0;" + NL + "" + NL + "    int deletedCount_";
  protected final String TEXT_54 = "=0;" + NL + "    int updatedCount_";
  protected final String TEXT_55 = "=0;" + NL + "    int insertedCount_";
  protected final String TEXT_56 = "=0;" + NL + "    int rejectedCount_";
  protected final String TEXT_57 = "=0;" + NL + "" + NL + "    boolean whetherReject_";
  protected final String TEXT_58 = " = false;" + NL + "" + NL + "    java.sql.Connection conn_";
  protected final String TEXT_59 = " = null;" + NL + "" + NL + "    //optional table" + NL + "    String dbschema_";
  protected final String TEXT_60 = " = null;" + NL + "    String tableName_";
  protected final String TEXT_61 = " = null;";
  protected final String TEXT_62 = NL + "\t\tdbschema_";
  protected final String TEXT_63 = ";";
  protected final String TEXT_64 = NL + "        dbschema_";
  protected final String TEXT_65 = " = (String)globalMap.get(\"";
  ...
  protected final String TEXT_72 = ") {" + NL + "    \t\t\tString dsAlias_";
  protected final String TEXT_73 = ";" + NL + "        \t\tif (dataSources_";
  protected final String TEXT_74 = ".get(dsAlias_";
  protected final String TEXT_75 = ") == null) {" + NL + "           \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_76 = " + \" available!\");" + NL + "              \t}" + NL + "        \t\tconn_";
  protected final String TEXT_77 = " = dataSources_";
  protected final String TEXT_78 = ").getConnection();" + NL + "    \t\t} else {";
  protected final String TEXT_79 = NL + "                    String driverClass_";
  protected final String TEXT_80 = " = \"oracle.jdbc.OracleDriver\";";
  protected final String TEXT_81 = " = \"oracle.jdbc.driver.OracleDriver\";";
  protected final String TEXT_82 = NL + NL + "                java.lang.Class.forName(driverClass_";
  protected final String TEXT_83 = NL + "                String url_";
  protected final String TEXT_84 = NL + "                    url_";
  protected final String TEXT_85 = " = \"jdbc:oracle:thin:@\" + ";
  protected final String TEXT_86 = " + \":\" + ";
  protected final String TEXT_87 = " = \"jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=\" + ";
  protected final String TEXT_88 = " + \")(port=\" + ";
  protected final String TEXT_89 = " + \"))(connect_data=(service_name=\" + ";
  protected final String TEXT_90 = " + \")))\";";
  protected final String TEXT_91 = " = \"jdbc:oracle:oci8:@\" + ";
  ...
  protected final String TEXT_100 = ";" + NL + "                dbschema_";
  protected final String TEXT_101 = ";" + NL;
  protected final String TEXT_102 = NL + "                    conn_";
  protected final String TEXT_103 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_104 = ");" + NL + "                    if(dbschema_";
  protected final String TEXT_105 = "==null||\"\".equals(dbschema_";
  protected final String TEXT_106 = ")) //get schema from connection" + NL + "                    {" + NL + "                        dbschema_";
  protected final String TEXT_107 = "=conn_";
  protected final String TEXT_108 = ".getMetaData().getUserName();" + NL + "                    }" + NL;
  protected final String TEXT_109 = ", dbUser_";
  protected final String TEXT_110 = ", dbPwd_";
  protected final String TEXT_111 = NL + "                    java.util.Properties atnParamsPrope_";
  protected final String TEXT_112 = " = new java.util.Properties();" + NL + "                    atnParamsPrope_";
  protected final String TEXT_113 = ".put(\"user\",dbUser_";
  protected final String TEXT_114 = ");" + NL + "                    atnParamsPrope_";
  protected final String TEXT_115 = ".put(\"password\",dbPwd_";
  protected final String TEXT_116 = ");" + NL + "                    if(";
  protected final String TEXT_117 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_118 = ") && !\"\".equals(";
  protected final String TEXT_119 = ")){" + NL + "                        atnParamsPrope_";
  protected final String TEXT_120 = ".load(new java.io.ByteArrayInputStream(";
  protected final String TEXT_121 = ".replace(\"&\", \"\\n\").getBytes()));" + NL + "                    }" + NL + "                    conn_";
  protected final String TEXT_122 = ", atnParamsPrope_";
  protected final String TEXT_123 = NL + "            }";
  protected final String TEXT_124 = NL + "        resourceMap.put(\"conn_";
  protected final String TEXT_125 = "\", conn_";
  protected final String TEXT_126 = NL + "            conn_";
  protected final String TEXT_127 = ".setAutoCommit(false);" + NL + "            int commitEvery_";
  ...
  protected final String TEXT_133 = NL + "        int count_";
  protected final String TEXT_134 = NL + NL + "        if(dbschema_";
  ...
  protected final String TEXT_143 = NL + "  \ttableName_";
  ...
  protected final String TEXT_267 = ".getTables(";
  protected final String TEXT_268 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_273 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_274 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_275 = NL + "                                if(!whetherExist_";
  protected final String TEXT_276 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_277 = NL + "                                                      stmtCreate_";
  protected final String TEXT_278 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_279 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_280 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_281 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_282 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_286 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_291 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_292 = NL + "                                                  stmtCreate_";
  protected final String TEXT_293 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_294 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_295 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_296 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_297 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_301 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_302 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_306 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_307 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_308 = NL + "                              stmtTruncCount_";
  protected final String TEXT_309 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_310 = " = stmtTruncCount_";
  protected final String TEXT_311 = ".executeQuery(\"";
  protected final String TEXT_312 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_313 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_314 = " = rsTruncCount_";
  protected final String TEXT_315 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_316 = NL + "                              stmtTrunc_";
  protected final String TEXT_317 = NL + "                conn_";
  protected final String TEXT_318 = NL + "                stmtTrunc_";
  ...
  protected final String TEXT_325 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_326 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_327 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_331 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_332 = NL + "                String insert_";
  protected final String TEXT_333 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_334 = " + \" (";
  protected final String TEXT_335 = ") VALUES (";
  protected final String TEXT_336 = ")\";";
  protected final String TEXT_337 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_338 = " = new StringBuffer(insert_";
  protected final String TEXT_339 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_340 = ".insert(insert_";
  protected final String TEXT_341 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_342 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_343 = " =insertStringBuffer_";
  protected final String TEXT_344 = ".toString(); ";
  protected final String TEXT_345 = "    " + NL;
  protected final String TEXT_346 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_347 = ".prepareStatement(insert_";
  protected final String TEXT_348 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_349 = "\", pstmt_";
  protected final String TEXT_350 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_351 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_352 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_353 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_354 = ",insert_";
  protected final String TEXT_355 = ",keyPsmt_";
  protected final String TEXT_356 = NL + "                String update_";
  protected final String TEXT_357 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_358 = " + \" SET ";
  protected final String TEXT_359 = " WHERE ";
  protected final String TEXT_360 = "\";";
  protected final String TEXT_361 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_362 = " = new StringBuffer(update_";
  protected final String TEXT_363 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_364 = ".insert(update_";
  protected final String TEXT_365 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_366 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_367 = " =updateStringBuffer_";
  protected final String TEXT_368 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_369 = ".prepareStatement(update_";
  protected final String TEXT_370 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_371 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_372 = " + \" WHERE ";
  protected final String TEXT_373 = "\");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_374 = ");" + NL + "                String insert_";
  protected final String TEXT_375 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_376 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_377 = "\", pstmtInsert_";
  protected final String TEXT_378 = ");" + NL + "                String update_";
  protected final String TEXT_379 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_380 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_381 = "\", pstmtUpdate_";
  protected final String TEXT_382 = NL + "                String delete_";
  protected final String TEXT_383 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_384 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_385 = " = new StringBuffer(delete_";
  protected final String TEXT_386 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_387 = ".insert(delete_";
  protected final String TEXT_388 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_389 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_390 = " =deleteStringBuffer_";
  protected final String TEXT_391 = ".toString();  ";
  protected final String TEXT_392 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_393 = ".prepareStatement(delete_";
  protected final String TEXT_394 = NL + "                StringBuffer query_";
  protected final String TEXT_395 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_396 = " = insert_";
  protected final String TEXT_397 = ".split(\"\\\\?\");";
  protected final String TEXT_398 = NL + "\t\t\tupdate_";
  protected final String TEXT_399 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_400 = " = update_";
  protected final String TEXT_401 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_402 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_403 = NL + "\t\t\tdelete_";
  protected final String TEXT_404 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_405 = " = delete_";
  protected final String TEXT_406 = NL + "\t\t\treplace_";
  protected final String TEXT_407 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_408 = " = replace_";
  protected final String TEXT_409 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_410 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_411 = " = insertIgnore_";
  protected final String TEXT_412 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_413 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_414 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_415 = " = true;";
  protected final String TEXT_416 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_417 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_418 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_419 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_420 = " clobTypeUtil_";
  protected final String TEXT_421 = "=new ClobTypeUtil_";
  protected final String TEXT_422 = "();";
  protected final String TEXT_423 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_424 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_425 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_426 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_427 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_428 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_429 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_430 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_431 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_432 = " blobTypeUtil_";
  protected final String TEXT_433 = "=new BlobTypeUtil_";
  ...
  protected final String TEXT_439 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_440 = " =  null;";
  protected final String TEXT_441 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_442 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_443 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_444 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_445 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
