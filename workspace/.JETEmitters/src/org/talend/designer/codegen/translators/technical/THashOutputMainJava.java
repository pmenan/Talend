...
public class THashOutputMainJava
{
  ...
  protected final String TEXT_23 = "_\" + pid +\"_";
  protected final String TEXT_24 = "\");" + NL + "\t\t\tmf_";
  protected final String TEXT_25 = ".getResourceMap().put(\"tHashFile_";
  protected final String TEXT_26 = "\", tHashFile_";
  protected final String TEXT_27 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_28 = "Struct();";
  protected final String TEXT_29 = NL + "\t\t\toneRow_";
  protected final String TEXT_30 = NL + "        tHashFile_";
