...
package prise_en_main.testdate_0_1;
...
import routines.TestConvertionString;
 ...
 * @status
 */
public class testDate implements TalendJob {
	...
	private final String jobName = "testDate";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testDate.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFixedFlowInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_3.addRow(new String[] { "stringDate", "test", });
...
// ###############################
				...
				for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
					...
					row2.stringDate = "2022-10-12 15:25:31";

					row2.test = "2022-10-12 15:25:31";
...
///////////////////////		
						...
						if (test.stringDate != null) { //
							row_tLogRow_3[0] = FormatterUtils.format_Date(test.stringDate, "yyyy-MM-dd HH:mm:ss");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final testDate testDateClass = new testDate();

		int exitCode = testDateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testDate.class.getClassLoader()
					.getResourceAsStream("prise_en_main/testdate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testDate.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : testDate");
		}
